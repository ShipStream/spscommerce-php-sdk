...
class CarrierFreightDetailHeaderAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailHeaderAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierFreightDetailHeaderAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
