...
class CarrierFreightDetailHeaderChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailHeaderChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = CarrierFreightDetailHeaderChargesAllowancesItemsTaxesItems::schema();
