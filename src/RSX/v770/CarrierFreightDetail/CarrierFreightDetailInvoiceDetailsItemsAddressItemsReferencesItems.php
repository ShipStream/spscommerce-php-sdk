...
class CarrierFreightDetailInvoiceDetailsItemsAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierFreightDetailInvoiceDetailsItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
