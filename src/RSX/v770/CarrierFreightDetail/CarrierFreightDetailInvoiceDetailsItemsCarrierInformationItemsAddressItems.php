...
class CarrierFreightDetailInvoiceDetailsItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = CarrierFreightDetailInvoiceDetailsItemsCarrierInformationItemsAddressItemsDatesItems::schema();
