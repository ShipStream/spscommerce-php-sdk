...
class CarrierFreightDetailInvoiceDetailsItemsReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierFreightDetailInvoiceDetailsItemsReferencesItemsReferenceIDsItems::schema();
