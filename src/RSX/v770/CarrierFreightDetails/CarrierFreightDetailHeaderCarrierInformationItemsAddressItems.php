...
class CarrierFreightDetailHeaderCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailHeaderCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = CarrierFreightDetailHeaderCarrierInformationItemsAddressItemsDatesItems::schema();
