...
class CarrierFreightDetailHeaderReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierFreightDetailHeaderReferencesItemsReferenceIDsItems::schema();
