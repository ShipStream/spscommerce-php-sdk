...
class CarrierFreightDetailHeaderStopDetailsItemsAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailHeaderStopDetailsItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierFreightDetailHeaderStopDetailsItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
