...
class CarrierFreightDetailHeaderStopDetailsItemsCarrierInformationItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailHeaderStopDetailsItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var CarrierFreightDetailHeaderStopDetailsItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var CarrierFreightDetailHeaderStopDetailsItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = CarrierFreightDetailHeaderStopDetailsItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = CarrierFreightDetailHeaderStopDetailsItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = CarrierFreightDetailHeaderStopDetailsItemsCarrierInformationItemsSealNumbersItems::schema();
