...
class CarrierFreightDetailHeaderStopDetailsItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailHeaderStopDetailsItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = CarrierFreightDetailHeaderStopDetailsItemsCarrierInformationItemsAddressItemsDatesItems::schema();
