...
class CarrierFreightDetailInvoiceDetailsItemsAddressItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var CarrierFreightDetailInvoiceDetailsItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var CarrierFreightDetailInvoiceDetailsItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = CarrierFreightDetailInvoiceDetailsItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = CarrierFreightDetailInvoiceDetailsItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = CarrierFreightDetailInvoiceDetailsItemsAddressItemsDatesItems::schema();
