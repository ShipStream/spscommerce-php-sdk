...
class CarrierFreightDetailInvoiceDetailsItemsAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierFreightDetailInvoiceDetailsItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
