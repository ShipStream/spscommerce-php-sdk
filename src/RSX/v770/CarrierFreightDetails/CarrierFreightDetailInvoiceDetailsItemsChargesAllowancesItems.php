...
class CarrierFreightDetailInvoiceDetailsItemsChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = CarrierFreightDetailInvoiceDetailsItemsChargesAllowancesItemsTaxesItems::schema();
