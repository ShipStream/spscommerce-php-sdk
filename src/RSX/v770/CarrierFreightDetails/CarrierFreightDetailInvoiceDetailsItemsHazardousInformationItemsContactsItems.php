...
class CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItemsContactsItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItemsContactsItemsAdditionalContactDetailsItems::schema();
