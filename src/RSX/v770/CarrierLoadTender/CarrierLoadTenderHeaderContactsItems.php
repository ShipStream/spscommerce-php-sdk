...
class CarrierLoadTenderHeaderContactsItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderHeaderContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierLoadTenderHeaderContactsItemsAdditionalContactDetailsItems::schema();
