...
class CarrierLoadTenderStopDetailsItemsCargoDetailsItemsContactsItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsCargoDetailsItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierLoadTenderStopDetailsItemsCargoDetailsItemsContactsItemsAdditionalContactDetailsItems::schema();
