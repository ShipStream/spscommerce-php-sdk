 ...
 */
class CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsHazardousInformationItemsContactsItemsAdditionalContactDetailsItems extends ClassStructure
{
    /** @var string */
    public $contactQual;
