...
class CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsHazardousInformationItemsReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsHazardousInformationItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsHazardousInformationItemsReferencesItemsReferenceIDsItems::schema();
