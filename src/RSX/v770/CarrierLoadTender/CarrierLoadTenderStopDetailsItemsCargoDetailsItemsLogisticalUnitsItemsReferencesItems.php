...
class CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsReferencesItemsReferenceIDsItems::schema();
