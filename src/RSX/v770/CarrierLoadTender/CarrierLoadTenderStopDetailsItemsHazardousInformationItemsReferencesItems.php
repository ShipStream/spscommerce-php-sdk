...
class CarrierLoadTenderStopDetailsItemsHazardousInformationItemsReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsHazardousInformationItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierLoadTenderStopDetailsItemsHazardousInformationItemsReferencesItemsReferenceIDsItems::schema();
