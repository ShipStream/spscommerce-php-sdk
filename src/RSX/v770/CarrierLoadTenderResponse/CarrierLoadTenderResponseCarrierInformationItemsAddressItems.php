...
class CarrierLoadTenderResponseCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderResponseCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = CarrierLoadTenderResponseCarrierInformationItemsAddressItemsDatesItems::schema();
