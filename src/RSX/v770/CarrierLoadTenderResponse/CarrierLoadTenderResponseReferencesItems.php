...
class CarrierLoadTenderResponseReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderResponseReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierLoadTenderResponseReferencesItemsReferenceIDsItems::schema();
