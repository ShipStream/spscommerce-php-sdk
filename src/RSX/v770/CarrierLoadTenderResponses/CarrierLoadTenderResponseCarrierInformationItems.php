...
class CarrierLoadTenderResponseCarrierInformationItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderResponseCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var CarrierLoadTenderResponseCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var CarrierLoadTenderResponseCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = CarrierLoadTenderResponseCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = CarrierLoadTenderResponseCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = CarrierLoadTenderResponseCarrierInformationItemsSealNumbersItems::schema();
