...
class CarrierLoadTenderHeaderAddressItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var CarrierLoadTenderHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var CarrierLoadTenderHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = CarrierLoadTenderHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = CarrierLoadTenderHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = CarrierLoadTenderHeaderAddressItemsDatesItems::schema();
