...
class CarrierLoadTenderHeaderReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierLoadTenderHeaderReferencesItemsReferenceIDsItems::schema();
