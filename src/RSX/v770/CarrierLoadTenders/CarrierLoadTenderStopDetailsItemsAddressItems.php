...
class CarrierLoadTenderStopDetailsItemsAddressItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var CarrierLoadTenderStopDetailsItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var CarrierLoadTenderStopDetailsItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = CarrierLoadTenderStopDetailsItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = CarrierLoadTenderStopDetailsItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = CarrierLoadTenderStopDetailsItemsAddressItemsDatesItems::schema();
