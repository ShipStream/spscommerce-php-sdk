...
class CarrierLoadTenderStopDetailsItemsAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierLoadTenderStopDetailsItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
