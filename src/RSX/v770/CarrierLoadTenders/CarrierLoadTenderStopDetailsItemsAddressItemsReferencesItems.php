...
class CarrierLoadTenderStopDetailsItemsAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierLoadTenderStopDetailsItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
