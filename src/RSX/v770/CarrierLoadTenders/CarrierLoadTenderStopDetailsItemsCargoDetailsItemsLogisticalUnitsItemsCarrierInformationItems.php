...
class CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsCarrierInformationItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsCarrierInformationItemsSealNumbersItems::schema();
