...
class CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsContactsItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsContactsItemsAdditionalContactDetailsItems::schema();
