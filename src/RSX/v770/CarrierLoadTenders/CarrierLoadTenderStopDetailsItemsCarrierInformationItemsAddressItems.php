...
class CarrierLoadTenderStopDetailsItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = CarrierLoadTenderStopDetailsItemsCarrierInformationItemsAddressItemsDatesItems::schema();
