...
class CarrierLoadTenderStopDetailsItemsChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = CarrierLoadTenderStopDetailsItemsChargesAllowancesItemsTaxesItems::schema();
