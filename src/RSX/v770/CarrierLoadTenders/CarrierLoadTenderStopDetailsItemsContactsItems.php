...
class CarrierLoadTenderStopDetailsItemsContactsItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierLoadTenderStopDetailsItemsContactsItemsAdditionalContactDetailsItems::schema();
