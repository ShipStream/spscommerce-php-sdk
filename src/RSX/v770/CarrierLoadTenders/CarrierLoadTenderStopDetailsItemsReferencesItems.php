...
class CarrierLoadTenderStopDetailsItemsReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierLoadTenderStopDetailsItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierLoadTenderStopDetailsItemsReferencesItemsReferenceIDsItems::schema();
