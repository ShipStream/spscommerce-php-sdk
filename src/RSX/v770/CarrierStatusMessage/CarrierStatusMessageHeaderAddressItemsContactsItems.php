...
class CarrierStatusMessageHeaderAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var CarrierStatusMessageHeaderAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierStatusMessageHeaderAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
