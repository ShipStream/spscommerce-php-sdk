...
class CarrierStatusMessageStatusDetailsItemsAddressItems extends ClassStructure
{
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var CarrierStatusMessageStatusDetailsItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var CarrierStatusMessageStatusDetailsItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = CarrierStatusMessageStatusDetailsItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = CarrierStatusMessageStatusDetailsItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = CarrierStatusMessageStatusDetailsItemsAddressItemsDatesItems::schema();
