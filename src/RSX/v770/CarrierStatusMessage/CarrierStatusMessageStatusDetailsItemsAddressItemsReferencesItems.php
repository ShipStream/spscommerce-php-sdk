...
class CarrierStatusMessageStatusDetailsItemsAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierStatusMessageStatusDetailsItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
