...
class CarrierStatusMessageStatusDetailsItemsReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierStatusMessageStatusDetailsItemsReferencesItemsReferenceIDsItems::schema();
