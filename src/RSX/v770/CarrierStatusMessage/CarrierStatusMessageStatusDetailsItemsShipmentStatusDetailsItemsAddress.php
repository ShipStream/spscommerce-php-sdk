...
class CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddress extends ClassStructure
{
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddressReferencesItems[]|array */
    public $references;

    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddressContactsItems[]|array */
    public $contacts;

    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddressDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddressReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddressContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddressDatesItems::schema();
