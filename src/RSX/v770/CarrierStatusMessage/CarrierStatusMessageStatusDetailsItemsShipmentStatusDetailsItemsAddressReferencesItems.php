...
class CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddressReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddressReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddressReferencesItemsReferenceIDsItems::schema();
