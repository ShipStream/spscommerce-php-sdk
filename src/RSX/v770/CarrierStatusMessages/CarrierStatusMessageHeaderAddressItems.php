...
class CarrierStatusMessageHeaderAddressItems extends ClassStructure
{
    ...
    /** @var CarrierStatusMessageHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var CarrierStatusMessageHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var CarrierStatusMessageHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = CarrierStatusMessageHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = CarrierStatusMessageHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = CarrierStatusMessageHeaderAddressItemsDatesItems::schema();
