...
class CarrierStatusMessageHeaderReferencesItems extends ClassStructure
{
    ...
    /** @var CarrierStatusMessageHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierStatusMessageHeaderReferencesItemsReferenceIDsItems::schema();
