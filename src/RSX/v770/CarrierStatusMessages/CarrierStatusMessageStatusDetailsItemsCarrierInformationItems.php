...
class CarrierStatusMessageStatusDetailsItemsCarrierInformationItems extends ClassStructure
{
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var CarrierStatusMessageStatusDetailsItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var CarrierStatusMessageStatusDetailsItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = CarrierStatusMessageStatusDetailsItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = CarrierStatusMessageStatusDetailsItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = CarrierStatusMessageStatusDetailsItemsCarrierInformationItemsSealNumbersItems::schema();
