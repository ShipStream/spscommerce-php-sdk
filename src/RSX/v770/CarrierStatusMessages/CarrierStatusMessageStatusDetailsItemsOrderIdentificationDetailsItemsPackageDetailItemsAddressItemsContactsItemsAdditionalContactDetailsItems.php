 ...
 */
class CarrierStatusMessageStatusDetailsItemsOrderIdentificationDetailsItemsPackageDetailItemsAddressItemsContactsItemsAdditionalContactDetailsItems extends ClassStructure
{
    /** @var string */
    public $contactQual;
