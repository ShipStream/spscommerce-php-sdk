...
class CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddressContactsItems extends ClassStructure
{
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddressContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddressContactsItemsAdditionalContactDetailsItems::schema();
