...
class CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsCarrierInformation extends ClassStructure
{
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsCarrierInformationServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsCarrierInformationAddressItems[]|array */
    public $address;

    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsCarrierInformationSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsCarrierInformationServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsCarrierInformationAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsCarrierInformationSealNumbersItems::schema();
