...
class CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsCarrierInformationAddressItems extends ClassStructure
{
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsCarrierInformationAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsCarrierInformationAddressItemsDatesItems::schema();
