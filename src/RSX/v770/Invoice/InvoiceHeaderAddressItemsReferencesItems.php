...
class InvoiceHeaderAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var InvoiceHeaderAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = InvoiceHeaderAddressItemsReferencesItemsReferenceIDsItems::schema();
