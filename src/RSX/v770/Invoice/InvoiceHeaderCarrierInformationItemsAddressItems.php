...
class InvoiceHeaderCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var InvoiceHeaderCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = InvoiceHeaderCarrierInformationItemsAddressItemsDatesItems::schema();
