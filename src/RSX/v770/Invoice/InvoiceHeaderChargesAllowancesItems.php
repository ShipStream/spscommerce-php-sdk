...
class InvoiceHeaderChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var InvoiceHeaderChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = InvoiceHeaderChargesAllowancesItemsTaxesItems::schema();
