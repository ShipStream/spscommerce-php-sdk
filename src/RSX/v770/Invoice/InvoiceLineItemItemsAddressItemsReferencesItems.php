...
class InvoiceLineItemItemsAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var InvoiceLineItemItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = InvoiceLineItemItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
