...
class InvoiceHeaderAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var InvoiceHeaderAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = InvoiceHeaderAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
