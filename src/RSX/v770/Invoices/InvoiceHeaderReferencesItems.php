...
class InvoiceHeaderReferencesItems extends ClassStructure
{
    ...
    /** @var InvoiceHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = InvoiceHeaderReferencesItemsReferenceIDsItems::schema();
