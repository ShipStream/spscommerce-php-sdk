...
class InvoiceLineItemItemsAddressItems extends ClassStructure
{
    ...
    /** @var InvoiceLineItemItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var InvoiceLineItemItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var InvoiceLineItemItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = InvoiceLineItemItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = InvoiceLineItemItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = InvoiceLineItemItemsAddressItemsDatesItems::schema();
