...
class InvoiceLineItemItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var InvoiceLineItemItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = InvoiceLineItemItemsCarrierInformationItemsAddressItemsDatesItems::schema();
