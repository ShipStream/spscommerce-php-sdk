...
class InvoiceLineItemItemsChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var InvoiceLineItemItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = InvoiceLineItemItemsChargesAllowancesItemsTaxesItems::schema();
