 ...
 */
class InvoiceLineItemItemsMasterItemAttributeItems extends ClassStructure
{
    /** @var InvoiceLineItemItemsMasterItemAttributeItemsItemAttributeItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->itemAttribute->items = InvoiceLineItemItemsMasterItemAttributeItemsItemAttributeItems::schema();
