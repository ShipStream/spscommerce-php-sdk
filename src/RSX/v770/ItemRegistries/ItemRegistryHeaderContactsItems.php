...
class ItemRegistryHeaderContactsItems extends ClassStructure
{
    ...
    /** @var ItemRegistryHeaderContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = ItemRegistryHeaderContactsItemsAdditionalContactDetailsItems::schema();
