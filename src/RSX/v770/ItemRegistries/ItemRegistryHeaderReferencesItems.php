...
class ItemRegistryHeaderReferencesItems extends ClassStructure
{
    ...
    /** @var ItemRegistryHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ItemRegistryHeaderReferencesItemsReferenceIDsItems::schema();
