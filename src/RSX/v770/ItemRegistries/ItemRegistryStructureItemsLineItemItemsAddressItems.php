...
class ItemRegistryStructureItemsLineItemItemsAddressItems extends ClassStructure
{
    ...
    /** @var ItemRegistryStructureItemsLineItemItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var ItemRegistryStructureItemsLineItemItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var ItemRegistryStructureItemsLineItemItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = ItemRegistryStructureItemsLineItemItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = ItemRegistryStructureItemsLineItemItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = ItemRegistryStructureItemsLineItemItemsAddressItemsDatesItems::schema();
