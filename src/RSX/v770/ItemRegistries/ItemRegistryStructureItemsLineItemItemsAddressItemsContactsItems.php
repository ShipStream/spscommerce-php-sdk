...
class ItemRegistryStructureItemsLineItemItemsAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var ItemRegistryStructureItemsLineItemItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = ItemRegistryStructureItemsLineItemItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
