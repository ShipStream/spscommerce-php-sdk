...
class ItemRegistryStructureItemsLineItemItemsHazardousInformationItemsReferencesItems extends ClassStructure
{
    ...
    /** @var ItemRegistryStructureItemsLineItemItemsHazardousInformationItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ItemRegistryStructureItemsLineItemItemsHazardousInformationItemsReferencesItemsReferenceIDsItems::schema();
