...
class ItemRegistryStructureItemsLineItemItemsPalletInformationItems extends ClassStructure
{
    /** @var string Code to identify the pallet hierarchical level */
    public $palletQualifier;

    /** @var string The number of units inside the PalletQualifier */
    public $palletValue;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->palletValue = Schema::string();
