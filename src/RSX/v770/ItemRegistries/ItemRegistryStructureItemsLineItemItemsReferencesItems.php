...
class ItemRegistryStructureItemsLineItemItemsReferencesItems extends ClassStructure
{
    ...
    /** @var ItemRegistryStructureItemsLineItemItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ItemRegistryStructureItemsLineItemItemsReferencesItemsReferenceIDsItems::schema();
