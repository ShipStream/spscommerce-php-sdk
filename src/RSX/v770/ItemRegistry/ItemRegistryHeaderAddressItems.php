...
class ItemRegistryHeaderAddressItems extends ClassStructure
{
    ...
    /** @var ItemRegistryHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var ItemRegistryHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var ItemRegistryHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = ItemRegistryHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = ItemRegistryHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = ItemRegistryHeaderAddressItemsDatesItems::schema();
