...
class ItemRegistryStructureItemsLineItemItemsChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var ItemRegistryStructureItemsLineItemItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = ItemRegistryStructureItemsLineItemItemsChargesAllowancesItemsTaxesItems::schema();
