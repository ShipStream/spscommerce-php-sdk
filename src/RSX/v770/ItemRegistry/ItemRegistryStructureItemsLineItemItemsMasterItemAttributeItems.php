 ...
 */
class ItemRegistryStructureItemsLineItemItemsMasterItemAttributeItems extends ClassStructure
{
    /** @var ItemRegistryStructureItemsLineItemItemsMasterItemAttributeItemsItemAttributeItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->itemAttribute->items = ItemRegistryStructureItemsLineItemItemsMasterItemAttributeItemsItemAttributeItems::schema();
