...
class OrderHeaderChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var OrderHeaderChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = OrderHeaderChargesAllowancesItemsTaxesItems::schema();
