...
class OrderHeaderLeadTimeItemsReferencesItems extends ClassStructure
{
    ...
    /** @var OrderHeaderLeadTimeItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderHeaderLeadTimeItemsReferencesItemsReferenceIDsItems::schema();
