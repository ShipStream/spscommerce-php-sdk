...
class OrderLineItemItemsCarrierInformationItems extends ClassStructure
{
    ...
    /** @var OrderLineItemItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var OrderLineItemItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var OrderLineItemItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = OrderLineItemItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = OrderLineItemItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = OrderLineItemItemsCarrierInformationItemsSealNumbersItems::schema();
