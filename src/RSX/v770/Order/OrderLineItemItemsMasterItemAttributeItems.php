 ...
 */
class OrderLineItemItemsMasterItemAttributeItems extends ClassStructure
{
    /** @var OrderLineItemItemsMasterItemAttributeItemsItemAttributeItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->itemAttribute->items = OrderLineItemItemsMasterItemAttributeItemsItemAttributeItems::schema();
