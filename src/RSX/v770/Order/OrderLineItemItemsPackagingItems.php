...
class OrderLineItemItemsPackagingItems extends ClassStructure
{
    ...
    /** @var OrderLineItemItemsPackagingItemsMeasurementsItems[]|array */
    public $measurements;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->measurements->items = OrderLineItemItemsPackagingItemsMeasurementsItems::schema();
