...
class OrderLineItemItemsSublineItemsChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var OrderLineItemItemsSublineItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = OrderLineItemItemsSublineItemsChargesAllowancesItemsTaxesItems::schema();
