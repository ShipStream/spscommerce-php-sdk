...
class OrderAckHeaderAddressItems extends ClassStructure
{
    ...
    /** @var OrderAckHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var OrderAckHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var OrderAckHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = OrderAckHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = OrderAckHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = OrderAckHeaderAddressItemsDatesItems::schema();
