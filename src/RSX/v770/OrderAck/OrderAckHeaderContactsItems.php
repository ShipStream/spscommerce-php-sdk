...
class OrderAckHeaderContactsItems extends ClassStructure
{
    ...
    /** @var OrderAckHeaderContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = OrderAckHeaderContactsItemsAdditionalContactDetailsItems::schema();
