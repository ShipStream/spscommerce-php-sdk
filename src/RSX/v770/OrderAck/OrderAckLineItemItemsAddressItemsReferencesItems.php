...
class OrderAckLineItemItemsAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var OrderAckLineItemItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderAckLineItemItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
