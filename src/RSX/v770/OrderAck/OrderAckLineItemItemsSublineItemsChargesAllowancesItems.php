...
class OrderAckLineItemItemsSublineItemsChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var OrderAckLineItemItemsSublineItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = OrderAckLineItemItemsSublineItemsChargesAllowancesItemsTaxesItems::schema();
