...
class OrderAckLineItemItemsSublineItemsReferencesItems extends ClassStructure
{
    ...
    /** @var OrderAckLineItemItemsSublineItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderAckLineItemItemsSublineItemsReferencesItemsReferenceIDsItems::schema();
