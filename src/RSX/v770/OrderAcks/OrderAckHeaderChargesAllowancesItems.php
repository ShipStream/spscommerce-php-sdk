...
class OrderAckHeaderChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var OrderAckHeaderChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = OrderAckHeaderChargesAllowancesItemsTaxesItems::schema();
