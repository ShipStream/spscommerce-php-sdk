...
class OrderAckHeaderOrderHeader extends ClassStructure
{
    ...
    /** @var OrderAckHeaderOrderHeaderAdditionalPOTypeCodesItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalPOTypeCodes->items = OrderAckHeaderOrderHeaderAdditionalPOTypeCodesItems::schema();
