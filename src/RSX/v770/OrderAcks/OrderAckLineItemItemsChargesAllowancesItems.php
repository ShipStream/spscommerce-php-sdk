...
class OrderAckLineItemItemsChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var OrderAckLineItemItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = OrderAckLineItemItemsChargesAllowancesItemsTaxesItems::schema();
