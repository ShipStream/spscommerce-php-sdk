...
class OrderChangeHeaderCarrierInformationItems extends ClassStructure
{
    ...
    /** @var OrderChangeHeaderCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var OrderChangeHeaderCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var OrderChangeHeaderCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = OrderChangeHeaderCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = OrderChangeHeaderCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = OrderChangeHeaderCarrierInformationItemsSealNumbersItems::schema();
