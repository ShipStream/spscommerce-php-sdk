...
class OrderChangeHeaderReferencesItems extends ClassStructure
{
    ...
    /** @var OrderChangeHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderChangeHeaderReferencesItemsReferenceIDsItems::schema();
