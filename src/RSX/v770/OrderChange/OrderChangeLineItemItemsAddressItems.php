...
class OrderChangeLineItemItemsAddressItems extends ClassStructure
{
    ...
    /** @var OrderChangeLineItemItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var OrderChangeLineItemItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var OrderChangeLineItemItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = OrderChangeLineItemItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = OrderChangeLineItemItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = OrderChangeLineItemItemsAddressItemsDatesItems::schema();
