...
class OrderChangeLineItemItemsAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var OrderChangeLineItemItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = OrderChangeLineItemItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
