...
class OrderChangeLineItemItemsAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var OrderChangeLineItemItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderChangeLineItemItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
