...
class OrderChangeAckHeaderAddressItems extends ClassStructure
{
    ...
    /** @var OrderChangeAckHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var OrderChangeAckHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var OrderChangeAckHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = OrderChangeAckHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = OrderChangeAckHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = OrderChangeAckHeaderAddressItemsDatesItems::schema();
