...
class OrderChangeAckHeaderCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var OrderChangeAckHeaderCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = OrderChangeAckHeaderCarrierInformationItemsAddressItemsDatesItems::schema();
