...
class OrderChangeAckHeaderChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var OrderChangeAckHeaderChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = OrderChangeAckHeaderChargesAllowancesItemsTaxesItems::schema();
