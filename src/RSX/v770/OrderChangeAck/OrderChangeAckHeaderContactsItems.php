...
class OrderChangeAckHeaderContactsItems extends ClassStructure
{
    ...
    /** @var OrderChangeAckHeaderContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = OrderChangeAckHeaderContactsItemsAdditionalContactDetailsItems::schema();
