...
class OrderChangeAckLineItemItemsAddressItems extends ClassStructure
{
    ...
    /** @var OrderChangeAckLineItemItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var OrderChangeAckLineItemItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var OrderChangeAckLineItemItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = OrderChangeAckLineItemItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = OrderChangeAckLineItemItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = OrderChangeAckLineItemItemsAddressItemsDatesItems::schema();
