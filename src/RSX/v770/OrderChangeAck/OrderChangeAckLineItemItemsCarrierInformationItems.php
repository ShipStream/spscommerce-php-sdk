...
class OrderChangeAckLineItemItemsCarrierInformationItems extends ClassStructure
{
    ...
    /** @var OrderChangeAckLineItemItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var OrderChangeAckLineItemItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var OrderChangeAckLineItemItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = OrderChangeAckLineItemItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = OrderChangeAckLineItemItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = OrderChangeAckLineItemItemsCarrierInformationItemsSealNumbersItems::schema();
