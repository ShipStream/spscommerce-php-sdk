...
class OrderChangeAckLineItemItemsLineItemAcknowledgementItems extends ClassStructure
{
    ...
    /** @var OrderChangeAckLineItemItemsLineItemAcknowledgementItemsProductIDItems[]|array */
    public $productID;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = OrderChangeAckLineItemItemsLineItemAcknowledgementItemsProductIDItems::schema();
