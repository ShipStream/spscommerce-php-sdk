 ...
 */
class OrderChangeAckLineItemItemsMasterItemAttributeItems extends ClassStructure
{
    /** @var OrderChangeAckLineItemItemsMasterItemAttributeItemsItemAttributeItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->itemAttribute->items = OrderChangeAckLineItemItemsMasterItemAttributeItemsItemAttributeItems::schema();
