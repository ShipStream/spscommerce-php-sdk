...
class OrderChangeAckLineItemItemsSublineItemsReferencesItems extends ClassStructure
{
    ...
    /** @var OrderChangeAckLineItemItemsSublineItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderChangeAckLineItemItemsSublineItemsReferencesItemsReferenceIDsItems::schema();
