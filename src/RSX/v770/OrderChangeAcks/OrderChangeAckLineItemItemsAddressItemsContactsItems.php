...
class OrderChangeAckLineItemItemsAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var OrderChangeAckLineItemItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = OrderChangeAckLineItemItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
