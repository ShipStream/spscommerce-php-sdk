...
class OrderChangeAckLineItemItemsAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var OrderChangeAckLineItemItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderChangeAckLineItemItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
