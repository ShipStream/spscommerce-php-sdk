...
class OrderChangeAckLineItemItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var OrderChangeAckLineItemItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = OrderChangeAckLineItemItemsCarrierInformationItemsAddressItemsDatesItems::schema();
