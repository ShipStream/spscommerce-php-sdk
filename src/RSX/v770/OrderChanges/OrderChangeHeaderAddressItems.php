...
class OrderChangeHeaderAddressItems extends ClassStructure
{
    ...
    /** @var OrderChangeHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var OrderChangeHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var OrderChangeHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = OrderChangeHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = OrderChangeHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = OrderChangeHeaderAddressItemsDatesItems::schema();
