...
class OrderChangeHeaderAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var OrderChangeHeaderAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = OrderChangeHeaderAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
