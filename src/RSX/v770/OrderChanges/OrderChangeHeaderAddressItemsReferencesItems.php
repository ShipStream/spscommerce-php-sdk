...
class OrderChangeHeaderAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var OrderChangeHeaderAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderChangeHeaderAddressItemsReferencesItemsReferenceIDsItems::schema();
