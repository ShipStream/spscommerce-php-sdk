...
class OrderChangeHeaderChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var OrderChangeHeaderChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = OrderChangeHeaderChargesAllowancesItemsTaxesItems::schema();
