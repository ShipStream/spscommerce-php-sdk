...
class OrderChangeHeaderLeadTimeItemsReferencesItems extends ClassStructure
{
    ...
    /** @var OrderChangeHeaderLeadTimeItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderChangeHeaderLeadTimeItemsReferencesItemsReferenceIDsItems::schema();
