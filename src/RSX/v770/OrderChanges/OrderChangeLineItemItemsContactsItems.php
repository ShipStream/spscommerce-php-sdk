...
class OrderChangeLineItemItemsContactsItems extends ClassStructure
{
    ...
    /** @var OrderChangeLineItemItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = OrderChangeLineItemItemsContactsItemsAdditionalContactDetailsItems::schema();
