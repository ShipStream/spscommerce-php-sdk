...
class OrderChangeLineItemItemsSublineItemsReferencesItems extends ClassStructure
{
    ...
    /** @var OrderChangeLineItemItemsSublineItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderChangeLineItemItemsSublineItemsReferencesItemsReferenceIDsItems::schema();
