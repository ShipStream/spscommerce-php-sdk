...
class OrderHeaderAddressItems extends ClassStructure
{
    ...
    /** @var OrderHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var OrderHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var OrderHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = OrderHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = OrderHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = OrderHeaderAddressItemsDatesItems::schema();
