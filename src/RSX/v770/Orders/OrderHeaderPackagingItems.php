...
class OrderHeaderPackagingItems extends ClassStructure
{
    ...
    /** @var OrderHeaderPackagingItemsMeasurementsItems[]|array */
    public $measurements;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->measurements->items = OrderHeaderPackagingItemsMeasurementsItems::schema();
