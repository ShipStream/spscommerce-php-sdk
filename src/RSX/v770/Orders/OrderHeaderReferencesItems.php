...
class OrderHeaderReferencesItems extends ClassStructure
{
    ...
    /** @var OrderHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderHeaderReferencesItemsReferenceIDsItems::schema();
