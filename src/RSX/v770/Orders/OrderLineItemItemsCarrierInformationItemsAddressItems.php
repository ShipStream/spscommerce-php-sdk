...
class OrderLineItemItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var OrderLineItemItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = OrderLineItemItemsCarrierInformationItemsAddressItemsDatesItems::schema();
