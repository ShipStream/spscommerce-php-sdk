...
class OrderLineItemItemsChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var OrderLineItemItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = OrderLineItemItemsChargesAllowancesItemsTaxesItems::schema();
