...
class OrderLineItemItemsConditionOfSaleItems extends ClassStructure
{
    ...
    /** @var OrderLineItemItemsConditionOfSaleItemsProductIDItems[]|array */
    public $productID;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = OrderLineItemItemsConditionOfSaleItemsProductIDItems::schema();
