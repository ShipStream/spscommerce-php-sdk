 ...
 */
class OrderLineItemItemsMasterItemAttributeItemsItemAttributeItems extends ClassStructure
{
    ...
    /** @var OrderLineItemItemsMasterItemAttributeItemsItemAttributeItemsMeasurementsItems[]|array */
    public $measurements;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->measurements->items = OrderLineItemItemsMasterItemAttributeItemsItemAttributeItemsMeasurementsItems::schema();
