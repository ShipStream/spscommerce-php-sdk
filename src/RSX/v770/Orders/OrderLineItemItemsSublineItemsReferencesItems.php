...
class OrderLineItemItemsSublineItemsReferencesItems extends ClassStructure
{
    ...
    /** @var OrderLineItemItemsSublineItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderLineItemItemsSublineItemsReferencesItemsReferenceIDsItems::schema();
