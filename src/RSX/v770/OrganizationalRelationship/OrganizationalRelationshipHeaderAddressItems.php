...
class OrganizationalRelationshipHeaderAddressItems extends ClassStructure
{
    ...
    /** @var OrganizationalRelationshipHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var OrganizationalRelationshipHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var OrganizationalRelationshipHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = OrganizationalRelationshipHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = OrganizationalRelationshipHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = OrganizationalRelationshipHeaderAddressItemsDatesItems::schema();
