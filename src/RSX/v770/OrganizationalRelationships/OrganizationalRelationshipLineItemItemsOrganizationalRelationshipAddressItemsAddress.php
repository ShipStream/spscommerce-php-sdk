...
class OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItemsAddress extends ClassStructure
{
    ...
    /** @var OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItemsAddressReferencesItems[]|array */
    public $references;

    /** @var OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItemsAddressContactsItems[]|array */
    public $contacts;

    /** @var OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItemsAddressDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItemsAddressReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItemsAddressContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItemsAddressDatesItems::schema();
