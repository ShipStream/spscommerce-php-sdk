...
class PlanningScheduleHeaderAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var PlanningScheduleHeaderAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = PlanningScheduleHeaderAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
