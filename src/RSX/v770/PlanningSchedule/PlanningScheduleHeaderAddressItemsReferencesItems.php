...
class PlanningScheduleHeaderAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var PlanningScheduleHeaderAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = PlanningScheduleHeaderAddressItemsReferencesItemsReferenceIDsItems::schema();
