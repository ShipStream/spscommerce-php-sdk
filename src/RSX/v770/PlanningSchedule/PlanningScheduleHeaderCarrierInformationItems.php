...
class PlanningScheduleHeaderCarrierInformationItems extends ClassStructure
{
    ...
    /** @var PlanningScheduleHeaderCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var PlanningScheduleHeaderCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var PlanningScheduleHeaderCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = PlanningScheduleHeaderCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = PlanningScheduleHeaderCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = PlanningScheduleHeaderCarrierInformationItemsSealNumbersItems::schema();
