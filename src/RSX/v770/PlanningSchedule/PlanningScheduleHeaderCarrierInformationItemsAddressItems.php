...
class PlanningScheduleHeaderCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var PlanningScheduleHeaderCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = PlanningScheduleHeaderCarrierInformationItemsAddressItemsDatesItems::schema();
