...
class PlanningScheduleHeaderReferencesItems extends ClassStructure
{
    ...
    /** @var PlanningScheduleHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = PlanningScheduleHeaderReferencesItemsReferenceIDsItems::schema();
