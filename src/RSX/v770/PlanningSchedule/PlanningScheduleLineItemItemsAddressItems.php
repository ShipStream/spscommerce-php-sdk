...
class PlanningScheduleLineItemItemsAddressItems extends ClassStructure
{
    ...
    /** @var PlanningScheduleLineItemItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var PlanningScheduleLineItemItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var PlanningScheduleLineItemItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = PlanningScheduleLineItemItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = PlanningScheduleLineItemItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = PlanningScheduleLineItemItemsAddressItemsDatesItems::schema();
