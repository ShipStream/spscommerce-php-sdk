...
class PlanningScheduleLineItemItemsAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var PlanningScheduleLineItemItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = PlanningScheduleLineItemItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
