...
class PlanningScheduleLineItemItemsForecastDeliveryItemsForecastScheduleItemsReferences extends ClassStructure
{
    ...
    /** @var PlanningScheduleLineItemItemsForecastDeliveryItemsForecastScheduleItemsReferencesReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = PlanningScheduleLineItemItemsForecastDeliveryItemsForecastScheduleItemsReferencesReferenceIDsItems::schema();
