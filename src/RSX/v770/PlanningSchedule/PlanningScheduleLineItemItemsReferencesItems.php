...
class PlanningScheduleLineItemItemsReferencesItems extends ClassStructure
{
    ...
    /** @var PlanningScheduleLineItemItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = PlanningScheduleLineItemItemsReferencesItemsReferenceIDsItems::schema();
