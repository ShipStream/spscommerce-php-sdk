...
class PlanningScheduleLineItemItemsShipReceiveItemsReferencesItems extends ClassStructure
{
    ...
    /** @var PlanningScheduleLineItemItemsShipReceiveItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = PlanningScheduleLineItemItemsShipReceiveItemsReferencesItemsReferenceIDsItems::schema();
