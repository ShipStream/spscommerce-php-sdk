...
class PlanningScheduleLineItemItemsSublineItemsContactsItems extends ClassStructure
{
    ...
    /** @var PlanningScheduleLineItemItemsSublineItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = PlanningScheduleLineItemItemsSublineItemsContactsItemsAdditionalContactDetailsItems::schema();
