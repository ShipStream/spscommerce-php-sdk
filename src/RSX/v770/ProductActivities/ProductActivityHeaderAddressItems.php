...
class ProductActivityHeaderAddressItems extends ClassStructure
{
    ...
    /** @var ProductActivityHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var ProductActivityHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var ProductActivityHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = ProductActivityHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = ProductActivityHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = ProductActivityHeaderAddressItemsDatesItems::schema();
