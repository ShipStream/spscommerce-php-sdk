...
class ProductActivityLineItemItemsAddressItems extends ClassStructure
{
    ...
    /** @var ProductActivityLineItemItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var ProductActivityLineItemItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var ProductActivityLineItemItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = ProductActivityLineItemItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = ProductActivityLineItemItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = ProductActivityLineItemItemsAddressItemsDatesItems::schema();
