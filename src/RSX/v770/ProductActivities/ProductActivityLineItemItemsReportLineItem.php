...
class ProductActivityLineItemItemsReportLineItem extends ClassStructure
{
    ...
    /** @var string Unique Identifier of the specific item */
    public $sPSItemUID;
    ...
    /** @var ProductActivityLineItemItemsReportLineItemProductIDItems[]|array */
    public $productID;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->sPSItemUID = Schema::string();
        $properties->sPSItemUID->description = "Unique Identifier of the specific item";
        $ownerSchema->addPropertyMapping('SPSItemUID', self::names()->sPSItemUID);
        ...
        $properties->productID->items = ProductActivityLineItemItemsReportLineItemProductIDItems::schema();
