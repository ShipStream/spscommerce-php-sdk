...
class ProductActivityLineItemItemsAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var ProductActivityLineItemItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = ProductActivityLineItemItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
