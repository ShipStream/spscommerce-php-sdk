...
class ContainerLevelAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var ContainerLevelAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ContainerLevelAddressItemsReferencesItemsReferenceIDsItems::schema();
