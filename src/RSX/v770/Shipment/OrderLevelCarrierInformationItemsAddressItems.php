...
class OrderLevelCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var OrderLevelCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = OrderLevelCarrierInformationItemsAddressItemsDatesItems::schema();
