...
class OrderLevelChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var OrderLevelChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = OrderLevelChargesAllowancesItemsTaxesItems::schema();
