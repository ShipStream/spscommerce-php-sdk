...
class OrderLevelReferencesItems extends ClassStructure
{
    ...
    /** @var OrderLevelReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderLevelReferencesItemsReferenceIDsItems::schema();
