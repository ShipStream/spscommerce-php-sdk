...
class PackLevelAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var PackLevelAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = PackLevelAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
