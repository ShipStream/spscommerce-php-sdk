...
class ShipmentOrderLevelItemsAddressItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var ShipmentOrderLevelItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var ShipmentOrderLevelItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = ShipmentOrderLevelItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = ShipmentOrderLevelItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = ShipmentOrderLevelItemsAddressItemsDatesItems::schema();
