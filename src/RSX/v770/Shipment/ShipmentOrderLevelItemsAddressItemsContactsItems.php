...
class ShipmentOrderLevelItemsAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = ShipmentOrderLevelItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
