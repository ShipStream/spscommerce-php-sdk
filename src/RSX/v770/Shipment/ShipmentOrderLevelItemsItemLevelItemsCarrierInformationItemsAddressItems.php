...
class ShipmentOrderLevelItemsItemLevelItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsItemLevelItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = ShipmentOrderLevelItemsItemLevelItemsCarrierInformationItemsAddressItemsDatesItems::schema();
