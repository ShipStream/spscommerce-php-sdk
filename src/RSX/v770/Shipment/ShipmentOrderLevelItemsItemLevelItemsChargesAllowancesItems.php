...
class ShipmentOrderLevelItemsItemLevelItemsChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsItemLevelItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = ShipmentOrderLevelItemsItemLevelItemsChargesAllowancesItemsTaxesItems::schema();
