 ...
 */
class ShipmentOrderLevelItemsItemLevelItemsMasterItemAttributeItems extends ClassStructure
{
    /** @var ShipmentOrderLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->itemAttribute->items = ShipmentOrderLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItems::schema();
