...
class ShipmentOrderLevelItemsItemLevelItemsReferencesItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsItemLevelItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ShipmentOrderLevelItemsItemLevelItemsReferencesItemsReferenceIDsItems::schema();
