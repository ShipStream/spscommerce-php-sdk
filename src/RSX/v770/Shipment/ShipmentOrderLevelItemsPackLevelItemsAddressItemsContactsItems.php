...
class ShipmentOrderLevelItemsPackLevelItemsAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = ShipmentOrderLevelItemsPackLevelItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
