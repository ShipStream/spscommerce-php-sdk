...
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsCarrierInformationItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsCarrierInformationItemsSealNumbersItems::schema();
