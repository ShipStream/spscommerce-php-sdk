...
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsCarrierInformationItemsAddressItemsDatesItems::schema();
