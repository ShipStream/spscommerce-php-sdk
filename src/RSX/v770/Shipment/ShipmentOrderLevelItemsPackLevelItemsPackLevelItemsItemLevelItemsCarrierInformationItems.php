...
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsSealNumbersItems::schema();
