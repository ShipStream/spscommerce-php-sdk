...
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsChargesAllowancesItemsTaxesItems::schema();
