...
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsReferencesItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsReferencesItemsReferenceIDsItems::schema();
