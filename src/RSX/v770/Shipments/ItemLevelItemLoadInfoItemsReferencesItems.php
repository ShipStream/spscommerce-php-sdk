...
class ItemLevelItemLoadInfoItemsReferencesItems extends ClassStructure
{
    ...
    /** @var ItemLevelItemLoadInfoItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ItemLevelItemLoadInfoItemsReferencesItemsReferenceIDsItems::schema();
