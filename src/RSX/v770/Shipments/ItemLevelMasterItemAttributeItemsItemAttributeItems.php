 ...
 */
class ItemLevelMasterItemAttributeItemsItemAttributeItems extends ClassStructure
{
    ...
    /** @var ItemLevelMasterItemAttributeItemsItemAttributeItemsMeasurementsItems[]|array */
    public $measurements;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->measurements->items = ItemLevelMasterItemAttributeItemsItemAttributeItemsMeasurementsItems::schema();
