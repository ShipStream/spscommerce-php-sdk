...
class ItemLevelReferencesItems extends ClassStructure
{
    ...
    /** @var ItemLevelReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ItemLevelReferencesItemsReferenceIDsItems::schema();
