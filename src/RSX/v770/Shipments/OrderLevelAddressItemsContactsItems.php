...
class OrderLevelAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var OrderLevelAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = OrderLevelAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
