...
class OrderLevelAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var OrderLevelAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderLevelAddressItemsReferencesItemsReferenceIDsItems::schema();
