...
class ShipmentHeaderAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var ShipmentHeaderAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ShipmentHeaderAddressItemsReferencesItemsReferenceIDsItems::schema();
