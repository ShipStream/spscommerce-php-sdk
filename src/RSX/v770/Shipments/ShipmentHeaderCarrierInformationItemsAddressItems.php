...
class ShipmentHeaderCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var ShipmentHeaderCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = ShipmentHeaderCarrierInformationItemsAddressItemsDatesItems::schema();
