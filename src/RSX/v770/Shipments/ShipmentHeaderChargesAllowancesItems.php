...
class ShipmentHeaderChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var ShipmentHeaderChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = ShipmentHeaderChargesAllowancesItemsTaxesItems::schema();
