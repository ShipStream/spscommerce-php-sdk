...
class ShipmentOrderLevelItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = ShipmentOrderLevelItemsCarrierInformationItemsAddressItemsDatesItems::schema();
