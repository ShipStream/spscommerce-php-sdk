...
class ShipmentOrderLevelItemsChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = ShipmentOrderLevelItemsChargesAllowancesItemsTaxesItems::schema();
