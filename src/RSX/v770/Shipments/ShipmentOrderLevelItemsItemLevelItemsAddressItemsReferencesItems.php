...
class ShipmentOrderLevelItemsItemLevelItemsAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsItemLevelItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ShipmentOrderLevelItemsItemLevelItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
