...
class ShipmentOrderLevelItemsItemLevelItemsItemLoadInfoItemsReferencesItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsItemLevelItemsItemLoadInfoItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ShipmentOrderLevelItemsItemLevelItemsItemLoadInfoItemsReferencesItemsReferenceIDsItems::schema();
