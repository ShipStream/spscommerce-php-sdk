...
class ShipmentOrderLevelItemsPackLevelItemsAddressItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var ShipmentOrderLevelItemsPackLevelItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var ShipmentOrderLevelItemsPackLevelItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = ShipmentOrderLevelItemsPackLevelItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = ShipmentOrderLevelItemsPackLevelItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = ShipmentOrderLevelItemsPackLevelItemsAddressItemsDatesItems::schema();
