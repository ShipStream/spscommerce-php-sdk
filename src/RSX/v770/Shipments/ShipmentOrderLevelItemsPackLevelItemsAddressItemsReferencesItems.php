...
class ShipmentOrderLevelItemsPackLevelItemsAddressItemsReferencesItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ShipmentOrderLevelItemsPackLevelItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
