...
class ShipmentOrderLevelItemsPackLevelItemsChargesAllowancesItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = ShipmentOrderLevelItemsPackLevelItemsChargesAllowancesItemsTaxesItems::schema();
