...
class ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsItemLoadInfoItemsReferencesItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsItemLoadInfoItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsItemLoadInfoItemsReferencesItemsReferenceIDsItems::schema();
