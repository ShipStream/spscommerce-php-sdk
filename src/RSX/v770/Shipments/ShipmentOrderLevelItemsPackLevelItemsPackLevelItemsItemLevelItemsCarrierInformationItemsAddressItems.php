...
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsAddressItemsDatesItems::schema();
