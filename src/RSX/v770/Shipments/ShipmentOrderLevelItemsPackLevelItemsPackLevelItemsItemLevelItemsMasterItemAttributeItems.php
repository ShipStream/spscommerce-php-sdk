 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsMasterItemAttributeItems extends ClassStructure
{
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->itemAttribute->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItems::schema();
