 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItemsMeasurementsItems[]|array */
    public $measurements;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->measurements->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItemsMeasurementsItems::schema();
