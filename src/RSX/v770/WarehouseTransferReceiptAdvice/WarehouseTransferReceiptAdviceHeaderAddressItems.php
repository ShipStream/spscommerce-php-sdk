...
class WarehouseTransferReceiptAdviceHeaderAddressItems extends ClassStructure
{
    ...
    /** @var WarehouseTransferReceiptAdviceHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var WarehouseTransferReceiptAdviceHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var WarehouseTransferReceiptAdviceHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = WarehouseTransferReceiptAdviceHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = WarehouseTransferReceiptAdviceHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = WarehouseTransferReceiptAdviceHeaderAddressItemsDatesItems::schema();
