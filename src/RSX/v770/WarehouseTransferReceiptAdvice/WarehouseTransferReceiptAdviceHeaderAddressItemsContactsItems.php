...
class WarehouseTransferReceiptAdviceHeaderAddressItemsContactsItems extends ClassStructure
{
    ...
    /** @var WarehouseTransferReceiptAdviceHeaderAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = WarehouseTransferReceiptAdviceHeaderAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
