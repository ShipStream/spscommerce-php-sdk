...
class WarehouseTransferReceiptAdviceHeaderCarrierInformationItemsAddressItems extends ClassStructure
{
    ...
    /** @var WarehouseTransferReceiptAdviceHeaderCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = WarehouseTransferReceiptAdviceHeaderCarrierInformationItemsAddressItemsDatesItems::schema();
