...
class WarehouseTransferReceiptAdviceHeaderReferencesItems extends ClassStructure
{
    ...
    /** @var WarehouseTransferReceiptAdviceHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = WarehouseTransferReceiptAdviceHeaderReferencesItemsReferenceIDsItems::schema();
