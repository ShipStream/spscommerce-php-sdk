...
class WarehouseTransferReceiptAdviceOrderLevelLineItemItemsDetailResponseItemsReferencesItems extends ClassStructure
{
    ...
    /** @var WarehouseTransferReceiptAdviceOrderLevelLineItemItemsDetailResponseItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = WarehouseTransferReceiptAdviceOrderLevelLineItemItemsDetailResponseItemsReferencesItemsReferenceIDsItems::schema();
