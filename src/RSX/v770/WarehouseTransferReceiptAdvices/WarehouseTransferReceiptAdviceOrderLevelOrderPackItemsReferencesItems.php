...
class WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsReferencesItems extends ClassStructure
{
    ...
    /** @var WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsReferencesItemsReferenceIDsItems::schema();
