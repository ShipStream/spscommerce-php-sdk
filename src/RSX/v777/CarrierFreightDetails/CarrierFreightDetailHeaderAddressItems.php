 ...
 */
class CarrierFreightDetailHeaderAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var CarrierFreightDetailHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var CarrierFreightDetailHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var CarrierFreightDetailHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = CarrierFreightDetailHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = CarrierFreightDetailHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = CarrierFreightDetailHeaderAddressItemsDatesItems::schema();
