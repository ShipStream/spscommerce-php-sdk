 ...
 */
class CarrierFreightDetailHeaderAddressItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var CarrierFreightDetailHeaderAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierFreightDetailHeaderAddressItemsReferencesItemsReferenceIDsItems::schema();
