 ...
 */
class CarrierFreightDetailHeaderCarrierInformationItems extends ClassStructure
{
    const BK = 'BK';
    ...
    /** @var CarrierFreightDetailHeaderCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var CarrierFreightDetailHeaderCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var CarrierFreightDetailHeaderCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = CarrierFreightDetailHeaderCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = CarrierFreightDetailHeaderCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = CarrierFreightDetailHeaderCarrierInformationItemsSealNumbersItems::schema();
