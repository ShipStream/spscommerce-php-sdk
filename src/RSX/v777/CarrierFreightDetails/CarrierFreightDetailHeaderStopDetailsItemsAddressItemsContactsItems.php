 ...
 */
class CarrierFreightDetailHeaderStopDetailsItemsAddressItemsContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var CarrierFreightDetailHeaderStopDetailsItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierFreightDetailHeaderStopDetailsItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
