 ...
 */
class CarrierFreightDetailHeaderStopDetailsItemsOrderIdentificationDetailsItemsQuantitiesSchedulesLocationsItems extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var CarrierFreightDetailHeaderStopDetailsItemsOrderIdentificationDetailsItemsQuantitiesSchedulesLocationsItemsLocationQuantityItems[]|array */
    public $locationQuantity;

    /** @var CarrierFreightDetailHeaderStopDetailsItemsOrderIdentificationDetailsItemsQuantitiesSchedulesLocationsItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->totalQtyUOM->enum = array(
            self::CONST_01,
            self::CONST_03,
            self::CONST_12,
            self::CONST_15,
        ...
        $properties->locationQuantity->items = CarrierFreightDetailHeaderStopDetailsItemsOrderIdentificationDetailsItemsQuantitiesSchedulesLocationsItemsLocationQuantityItems::schema();
        $ownerSchema->addPropertyMapping('LocationQuantity', self::names()->locationQuantity);
        $properties->dates = Schema::arr();
        $properties->dates->items = CarrierFreightDetailHeaderStopDetailsItemsOrderIdentificationDetailsItemsQuantitiesSchedulesLocationsItemsDatesItems::schema();
