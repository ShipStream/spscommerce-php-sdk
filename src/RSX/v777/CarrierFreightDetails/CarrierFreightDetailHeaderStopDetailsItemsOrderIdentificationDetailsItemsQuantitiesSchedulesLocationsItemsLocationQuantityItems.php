...
/**
 * Relates an amount to a location
 */
class CarrierFreightDetailHeaderStopDetailsItemsOrderIdentificationDetailsItemsQuantitiesSchedulesLocationsItemsLocationQuantityItems extends ClassStructure
{
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $ownerSchema->description = "Relates an amount to a location";
