 ...
 */
class CarrierFreightDetailHeaderStopDetailsItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var CarrierFreightDetailHeaderStopDetailsItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierFreightDetailHeaderStopDetailsItemsReferencesItemsReferenceIDsItems::schema();
