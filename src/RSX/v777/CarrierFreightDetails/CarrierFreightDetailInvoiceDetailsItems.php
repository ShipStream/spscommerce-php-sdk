...
/**
 * Itemized list of content making up the freight bill
 */
class CarrierFreightDetailInvoiceDetailsItems extends ClassStructure
{
    /** @var CarrierFreightDetailInvoiceDetailsItemsInvoiceLine Contains the commonly used fields in the line item level of the transaction */
    public $invoiceLine;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $ownerSchema->description = "Itemized list of content making up the freight bill";
