 ...
 */
class CarrierFreightDetailInvoiceDetailsItemsCarrierInformationItems extends ClassStructure
{
    const BK = 'BK';
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var CarrierFreightDetailInvoiceDetailsItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var CarrierFreightDetailInvoiceDetailsItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = CarrierFreightDetailInvoiceDetailsItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = CarrierFreightDetailInvoiceDetailsItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = CarrierFreightDetailInvoiceDetailsItemsCarrierInformationItemsSealNumbersItems::schema();
