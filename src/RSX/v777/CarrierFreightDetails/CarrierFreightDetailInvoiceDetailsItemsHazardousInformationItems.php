 ...
 */
class CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItems extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItemsReferencesItems[]|array */
    public $references;

    /** @var CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItemsNotesItems[]|array */
    public $notes;

    /** @var CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItemsContactsItems[]|array */
    public $contacts;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->notes = Schema::arr();
        $properties->notes->items = CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItemsNotesItems::schema();
        $ownerSchema->addPropertyMapping('Notes', self::names()->notes);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItemsContactsItems::schema();
