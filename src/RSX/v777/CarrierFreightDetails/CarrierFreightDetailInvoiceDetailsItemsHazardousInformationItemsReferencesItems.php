 ...
 */
class CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierFreightDetailInvoiceDetailsItemsHazardousInformationItemsReferencesItemsReferenceIDsItems::schema();
