...
class CarrierFreightDetailInvoiceDetailsItemsTariffsItems extends ClassStructure
{
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsTariffsItemsAddress Represent an entity such as an organizational, physical location, property, or individual */
    public $address;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->distanceQualifier->enum = array(
            self::K,
            self::M,
        );
