 ...
 */
class CarrierFreightDetailInvoiceDetailsItemsTariffsItemsAddress extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsTariffsItemsAddressReferencesItems[]|array */
    public $references;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = CarrierFreightDetailInvoiceDetailsItemsTariffsItemsAddressReferencesItems::schema();
