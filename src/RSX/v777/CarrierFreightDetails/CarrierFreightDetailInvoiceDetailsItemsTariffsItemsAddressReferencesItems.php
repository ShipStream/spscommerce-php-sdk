 ...
 */
class CarrierFreightDetailInvoiceDetailsItemsTariffsItemsAddressReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var CarrierFreightDetailInvoiceDetailsItemsTariffsItemsAddressReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierFreightDetailInvoiceDetailsItemsTariffsItemsAddressReferencesItemsReferenceIDsItems::schema();
