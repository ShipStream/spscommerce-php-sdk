...
/**
 * A response to a presented shipment proposal. Acts as a confirmation or rejection of the shipment
...
{
    /** @var CarrierLoadTenderResponseMeta Information used for internal purposes at SPS Commerce */
    public $meta;

    /** @var CarrierLoadTenderResponseLoadTenderResponseHeader Contains the commonly used fields in the header of the transaction */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $ownerSchema->description = "A response to a presented shipment proposal. Acts as a confirmation or rejection of the shipment";
