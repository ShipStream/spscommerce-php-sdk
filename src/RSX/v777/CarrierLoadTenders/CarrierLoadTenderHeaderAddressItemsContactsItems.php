 ...
 */
class CarrierLoadTenderHeaderAddressItemsContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var CarrierLoadTenderHeaderAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierLoadTenderHeaderAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
