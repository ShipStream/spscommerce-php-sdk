 ...
 */
class CarrierLoadTenderHeaderCarrierInformationItems extends ClassStructure
{
    const BK = 'BK';
    ...
    /** @var CarrierLoadTenderHeaderCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var CarrierLoadTenderHeaderCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var CarrierLoadTenderHeaderCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = CarrierLoadTenderHeaderCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = CarrierLoadTenderHeaderCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = CarrierLoadTenderHeaderCarrierInformationItemsSealNumbersItems::schema();
