 ...
 */
class CarrierLoadTenderHeaderChargesAllowancesItems extends ClassStructure
{
    const A = 'A';
    ...
    /** @var CarrierLoadTenderHeaderChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = CarrierLoadTenderHeaderChargesAllowancesItemsTaxesItems::schema();
