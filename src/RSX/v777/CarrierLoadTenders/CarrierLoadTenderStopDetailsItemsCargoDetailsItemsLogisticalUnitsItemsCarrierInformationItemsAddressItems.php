 ...
 */
class CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsCarrierInformationItemsAddressItemsDatesItems::schema();
