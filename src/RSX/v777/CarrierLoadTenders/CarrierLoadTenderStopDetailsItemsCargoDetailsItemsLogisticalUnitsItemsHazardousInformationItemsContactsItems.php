 ...
 */
class CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsHazardousInformationItemsContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsHazardousInformationItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierLoadTenderStopDetailsItemsCargoDetailsItemsLogisticalUnitsItemsHazardousInformationItemsContactsItemsAdditionalContactDetailsItems::schema();
