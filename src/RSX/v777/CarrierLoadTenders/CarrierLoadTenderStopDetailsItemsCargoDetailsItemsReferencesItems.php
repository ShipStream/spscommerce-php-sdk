 ...
 */
class CarrierLoadTenderStopDetailsItemsCargoDetailsItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var CarrierLoadTenderStopDetailsItemsCargoDetailsItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierLoadTenderStopDetailsItemsCargoDetailsItemsReferencesItemsReferenceIDsItems::schema();
