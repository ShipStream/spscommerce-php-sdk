 ...
 */
class CarrierLoadTenderStopDetailsItemsCarrierInformationItems extends ClassStructure
{
    const BK = 'BK';
    ...
    /** @var CarrierLoadTenderStopDetailsItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var CarrierLoadTenderStopDetailsItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var CarrierLoadTenderStopDetailsItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = CarrierLoadTenderStopDetailsItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = CarrierLoadTenderStopDetailsItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = CarrierLoadTenderStopDetailsItemsCarrierInformationItemsSealNumbersItems::schema();
