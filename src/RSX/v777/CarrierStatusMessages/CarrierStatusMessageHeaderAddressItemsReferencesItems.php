 ...
 */
class CarrierStatusMessageHeaderAddressItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var CarrierStatusMessageHeaderAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = CarrierStatusMessageHeaderAddressItemsReferencesItemsReferenceIDsItems::schema();
