 ...
 */
class CarrierStatusMessageHeaderCarrierInformationItems extends ClassStructure
{
    const BK = 'BK';
    ...
    /** @var CarrierStatusMessageHeaderCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var CarrierStatusMessageHeaderCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var CarrierStatusMessageHeaderCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = CarrierStatusMessageHeaderCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = CarrierStatusMessageHeaderCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = CarrierStatusMessageHeaderCarrierInformationItemsSealNumbersItems::schema();
