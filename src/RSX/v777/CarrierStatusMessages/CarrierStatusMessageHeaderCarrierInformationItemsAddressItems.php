 ...
 */
class CarrierStatusMessageHeaderCarrierInformationItemsAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var CarrierStatusMessageHeaderCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = CarrierStatusMessageHeaderCarrierInformationItemsAddressItemsDatesItems::schema();
