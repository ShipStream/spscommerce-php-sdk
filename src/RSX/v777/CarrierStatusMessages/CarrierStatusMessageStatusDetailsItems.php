...
/**
 * Encloses all document status detail elements
 */
class CarrierStatusMessageStatusDetailsItems extends ClassStructure
{
    /** @var CarrierStatusMessageStatusDetailsItemsStatusLine Contains the commonly used fields in the line item level of the transaction */
    public $statusLine;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $ownerSchema->description = "Encloses all document status detail elements";
