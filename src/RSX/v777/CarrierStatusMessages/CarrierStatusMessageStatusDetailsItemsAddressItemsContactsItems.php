 ...
 */
class CarrierStatusMessageStatusDetailsItemsAddressItemsContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = CarrierStatusMessageStatusDetailsItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
