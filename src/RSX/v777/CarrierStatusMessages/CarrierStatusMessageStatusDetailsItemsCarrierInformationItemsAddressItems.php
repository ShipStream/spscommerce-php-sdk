 ...
 */
class CarrierStatusMessageStatusDetailsItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = CarrierStatusMessageStatusDetailsItemsCarrierInformationItemsAddressItemsDatesItems::schema();
