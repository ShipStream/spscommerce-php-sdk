 ...
 */
class CarrierStatusMessageStatusDetailsItemsOrderIdentificationDetailsItemsPackageDetailItemsShipmentStatusDetailsItemsAddressContactsItemsAdditionalContactDetailsItems extends ClassStructure
{
    const AU = 'AU';
