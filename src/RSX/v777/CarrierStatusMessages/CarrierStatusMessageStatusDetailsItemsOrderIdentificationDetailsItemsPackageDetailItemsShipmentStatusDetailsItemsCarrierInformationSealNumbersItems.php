 ...
 */
class CarrierStatusMessageStatusDetailsItemsOrderIdentificationDetailsItemsPackageDetailItemsShipmentStatusDetailsItemsCarrierInformationSealNumbersItems extends ClassStructure
{
    const CONST_01 = '01';
