 ...
 */
class CarrierStatusMessageStatusDetailsItemsOrderIdentificationDetailsItemsQuantitiesSchedulesLocationsItems extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsOrderIdentificationDetailsItemsQuantitiesSchedulesLocationsItemsLocationQuantityItems[]|array */
    public $locationQuantity;

    /** @var CarrierStatusMessageStatusDetailsItemsOrderIdentificationDetailsItemsQuantitiesSchedulesLocationsItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->locationQuantity->items = CarrierStatusMessageStatusDetailsItemsOrderIdentificationDetailsItemsQuantitiesSchedulesLocationsItemsLocationQuantityItems::schema();
        $ownerSchema->addPropertyMapping('LocationQuantity', self::names()->locationQuantity);
        $properties->dates = Schema::arr();
        $properties->dates->items = CarrierStatusMessageStatusDetailsItemsOrderIdentificationDetailsItemsQuantitiesSchedulesLocationsItemsDatesItems::schema();
