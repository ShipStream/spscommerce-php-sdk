 ...
 */
class CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItems extends ClassStructure
{
    const A7 = 'A7';
    ...
    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsDates Provides date and time information */
    public $dates;

    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddress Represent an entity such as an organizational, physical location, property, or individual */
    public $address;

    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsCarrierInformation Specifies carrier identity, transportation information, and equipment details */
    public $carrierInformation;

    /** @var CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsNotesItems[]|array */
    public $notes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsDates::schema();
        $ownerSchema->addPropertyMapping('Dates', self::names()->dates);
        $properties->address = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsAddress::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->carrierInformation = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsCarrierInformation::schema();
        $ownerSchema->addPropertyMapping('CarrierInformation', self::names()->carrierInformation);
        $properties->notes = Schema::arr();
        $properties->notes->items = CarrierStatusMessageStatusDetailsItemsShipmentStatusDetailsItemsNotesItems::schema();
