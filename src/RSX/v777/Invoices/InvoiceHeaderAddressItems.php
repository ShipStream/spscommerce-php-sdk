 ...
 */
class InvoiceHeaderAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var InvoiceHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var InvoiceHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var InvoiceHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = InvoiceHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = InvoiceHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = InvoiceHeaderAddressItemsDatesItems::schema();
