 ...
 */
class InvoiceHeaderContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var InvoiceHeaderContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = InvoiceHeaderContactsItemsAdditionalContactDetailsItems::schema();
