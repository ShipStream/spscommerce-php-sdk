 ...
 */
class InvoiceLineItemItemsAddressItemsContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var InvoiceLineItemItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = InvoiceLineItemItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
