 ...
 */
class InvoiceLineItemItemsCarrierInformationItems extends ClassStructure
{
    const BK = 'BK';
    ...
    public $transitTimeQualifier;

    /** @var float Amount of time associated with a transportation stage */
    public $transitTime;

    /** @var InvoiceLineItemItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var InvoiceLineItemItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var InvoiceLineItemItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->transitTimeQualifier = Schema::string();
        $properties->transitTimeQualifier->description = "Code qualifying the amount of time associated with a transportation stage";
        $ownerSchema->addPropertyMapping('TransitTimeQualifier', self::names()->transitTimeQualifier);
        ...
        $properties->serviceLevelCodes->items = InvoiceLineItemItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = InvoiceLineItemItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = InvoiceLineItemItemsCarrierInformationItemsSealNumbersItems::schema();
