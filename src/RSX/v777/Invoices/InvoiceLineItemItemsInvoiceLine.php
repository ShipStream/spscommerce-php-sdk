 ...
 */
class InvoiceLineItemItemsInvoiceLine extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var InvoiceLineItemItemsInvoiceLineProductIDItems[]|array */
    public $productID;

    /** @var float Quantity being billed */
    public $invoiceQty;

    /** @var string Unit of measure used in relation with the InvoiceQty */
    ...
    /** @var string Code indicating the quantity of an order, shipment, or the disposition of any difference between the quantity ordered and quantity shipped for a line item */
    public $qtyLeftToReceiveStatus;
    ...
    /** @var string A flag to indicate if cash discount is applicable to the item */
    public $cashDiscount;

    /** @var string Type of sale or service being provided. This field is typically used in Tradacoms. */
    public $saleOrService;

    /** @var InvoiceLineItemItemsInvoiceLineNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = InvoiceLineItemItemsInvoiceLineProductIDItems::schema();
        $ownerSchema->addPropertyMapping('ProductID', self::names()->productID);
        $properties->invoiceQty = Schema::number();
        $properties->invoiceQty->description = "Quantity being billed";
        $ownerSchema->addPropertyMapping('InvoiceQty', self::names()->invoiceQty);
        $properties->invoiceQtyUOM = Schema::string();
        $properties->invoiceQtyUOM->enum = array(
            self::CONST_01,
            self::CONST_03,
            self::CONST_12,
            self::CONST_15,
        ...
        $properties->invoiceQtyUOM->description = "Unit of measure used in relation with the InvoiceQty";
        $ownerSchema->addPropertyMapping('InvoiceQtyUOM', self::names()->invoiceQtyUOM);
        ...
        $properties->qtyLeftToReceiveStatus = Schema::string();
        $properties->qtyLeftToReceiveStatus->enum = array(
            self::BO,
            self::DI,
            self::IC,
            self::IS,
        ...
        $properties->qtyLeftToReceiveStatus->description = "Code indicating the quantity of an order, shipment, or the disposition of any difference between the quantity ordered and quantity shipped for a line item";
        $ownerSchema->addPropertyMapping('QtyLeftToReceiveStatus', self::names()->qtyLeftToReceiveStatus);
        ...
        $properties->cashDiscount = Schema::string();
        $properties->cashDiscount->enum = array(
            self::N,
            self::Y,
        );
        $properties->cashDiscount->description = "A flag to indicate if cash discount is applicable to the item";
        $ownerSchema->addPropertyMapping('CashDiscount', self::names()->cashDiscount);
        $properties->saleOrService = Schema::string();
        $properties->saleOrService->enum = array(
            self::A,
            self::B,
            self::C,
            self::D,
        ...
        $properties->saleOrService->description = "Type of sale or service being provided. This field is typically used in Tradacoms.";
        $ownerSchema->addPropertyMapping('SaleOrService', self::names()->saleOrService);
        $properties->nRFStandardColorAndSize = InvoiceLineItemItemsInvoiceLineNRFStandardColorAndSize::schema();
