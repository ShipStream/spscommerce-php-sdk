 ...
 */
class InvoiceLineItemItemsSublineItemsSublineItemDetail extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var InvoiceLineItemItemsSublineItemsSublineItemDetailProductIDItems[]|array */
    public $productID;
    ...
    /** @var InvoiceLineItemItemsSublineItemsSublineItemDetailNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = InvoiceLineItemItemsSublineItemsSublineItemDetailProductIDItems::schema();
        ...
        $properties->nRFStandardColorAndSize = InvoiceLineItemItemsSublineItemsSublineItemDetailNRFStandardColorAndSize::schema();
