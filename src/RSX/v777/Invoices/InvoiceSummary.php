...
class InvoiceSummary extends ClassStructure
{
    ...
    /** @var float Sum of enclosed freight charges */
    public $totalFreightCharges;

    /** @var float Sum of enclosed non-freight charges */
    ...
    /** @var float Sum of enclosed allowances */
    public $totalAllowancesAmount;

    /** @var float Sum of enclosed carton quantities */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->totalFreightCharges->description = "Sum of enclosed freight charges";
        ...
        $properties->totalNonFreightCharges->description = "Sum of enclosed non-freight charges";
        ...
        $properties->totalAllowancesAmount->description = "Sum of enclosed allowances";
        ...
        $properties->totalCartonCount->description = "Sum of enclosed carton quantities";
