 ...
 */
class ItemRegistryHeaderAddressItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var ItemRegistryHeaderAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ItemRegistryHeaderAddressItemsReferencesItemsReferenceIDsItems::schema();
