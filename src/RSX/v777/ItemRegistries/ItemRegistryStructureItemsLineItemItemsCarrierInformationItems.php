 ...
 */
class ItemRegistryStructureItemsLineItemItemsCarrierInformationItems extends ClassStructure
{
    const BK = 'BK';
    ...
    /** @var ItemRegistryStructureItemsLineItemItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var ItemRegistryStructureItemsLineItemItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var ItemRegistryStructureItemsLineItemItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = ItemRegistryStructureItemsLineItemItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = ItemRegistryStructureItemsLineItemItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = ItemRegistryStructureItemsLineItemItemsCarrierInformationItemsSealNumbersItems::schema();
