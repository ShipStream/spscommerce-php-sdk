 ...
 */
class ItemRegistryStructureItemsLineItemItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var ItemRegistryStructureItemsLineItemItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = ItemRegistryStructureItemsLineItemItemsCarrierInformationItemsAddressItemsDatesItems::schema();
