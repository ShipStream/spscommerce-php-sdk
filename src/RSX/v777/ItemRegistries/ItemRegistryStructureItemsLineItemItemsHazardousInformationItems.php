 ...
 */
class ItemRegistryStructureItemsLineItemItemsHazardousInformationItems extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var ItemRegistryStructureItemsLineItemItemsHazardousInformationItemsReferencesItems[]|array */
    public $references;

    /** @var ItemRegistryStructureItemsLineItemItemsHazardousInformationItemsNotesItems[]|array */
    public $notes;

    /** @var ItemRegistryStructureItemsLineItemItemsHazardousInformationItemsContactsItems[]|array */
    public $contacts;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = ItemRegistryStructureItemsLineItemItemsHazardousInformationItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->notes = Schema::arr();
        $properties->notes->items = ItemRegistryStructureItemsLineItemItemsHazardousInformationItemsNotesItems::schema();
        $ownerSchema->addPropertyMapping('Notes', self::names()->notes);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = ItemRegistryStructureItemsLineItemItemsHazardousInformationItemsContactsItems::schema();
