 ...
 */
class ItemRegistryStructureItemsLineItemItemsHazardousInformationItemsContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var ItemRegistryStructureItemsLineItemItemsHazardousInformationItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = ItemRegistryStructureItemsLineItemItemsHazardousInformationItemsContactsItemsAdditionalContactDetailsItems::schema();
