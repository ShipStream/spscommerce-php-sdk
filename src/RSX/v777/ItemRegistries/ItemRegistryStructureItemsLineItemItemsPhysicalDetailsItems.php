...
/**
 * Details of the outer, inner, and consumer package
 */
class ItemRegistryStructureItemsLineItemItemsPhysicalDetailsItems extends ClassStructure
{
    const CP = 'CP';
    ...
    /** @var string The number of units inside the PackQualifier */
    public $packValue;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->packQualifier->enum = array(
            self::CP,
            self::IN,
            self::OU,
        );
        ...
        $properties->packValue = Schema::string();
        ...
        $properties->packWeightUOM->enum = array(
            self::CONST_01,
            self::CONST_50,
            self::AF,
            self::CD,
        ...
        $properties->packVolumeUOM->enum = array(
            self::CONST_4_G,
            self::CONST_5_I,
            self::BF,
            self::C3,
        ...
        $ownerSchema->description = "Details of the outer, inner, and consumer package";
