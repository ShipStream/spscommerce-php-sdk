 ...
 */
class ItemRegistryStructureItemsLineItemItemsPriceDetailsItems extends ClassStructure
{
    const AQ = 'AQ';
    ...
    /** @var string Identifies the trading partner for whom pricing is intended */
    public $partnerID;

    /** @var ItemRegistryStructureItemsLineItemItemsPriceDetailsItemsPricingAreaItems[]|array */
    public $pricingArea;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->partnerID = Schema::string();
        $properties->partnerID->description = "Identifies the trading partner for whom pricing is intended";
        $ownerSchema->addPropertyMapping('PartnerID', self::names()->partnerID);
        $properties->pricingArea = Schema::arr();
        $properties->pricingArea->items = ItemRegistryStructureItemsLineItemItemsPriceDetailsItemsPricingAreaItems::schema();
        $ownerSchema->addPropertyMapping('PricingArea', self::names()->pricingArea);
