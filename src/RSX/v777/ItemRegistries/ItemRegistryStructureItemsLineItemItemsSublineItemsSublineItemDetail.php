 ...
 */
class ItemRegistryStructureItemsLineItemItemsSublineItemsSublineItemDetail extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var ItemRegistryStructureItemsLineItemItemsSublineItemsSublineItemDetailProductIDItems[]|array */
    public $productID;
    ...
    /** @var ItemRegistryStructureItemsLineItemItemsSublineItemsSublineItemDetailNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = ItemRegistryStructureItemsLineItemItemsSublineItemsSublineItemDetailProductIDItems::schema();
        ...
        $properties->nRFStandardColorAndSize = ItemRegistryStructureItemsLineItemItemsSublineItemsSublineItemDetailNRFStandardColorAndSize::schema();
