 ...
 */
class OrderAckHeaderReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var OrderAckHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderAckHeaderReferencesItemsReferenceIDsItems::schema();
