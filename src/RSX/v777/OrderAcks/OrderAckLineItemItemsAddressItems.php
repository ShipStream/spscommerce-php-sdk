 ...
 */
class OrderAckLineItemItemsAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var OrderAckLineItemItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var OrderAckLineItemItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var OrderAckLineItemItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = OrderAckLineItemItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = OrderAckLineItemItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = OrderAckLineItemItemsAddressItemsDatesItems::schema();
