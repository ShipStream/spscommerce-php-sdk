 ...
 */
class OrderAckLineItemItemsCarrierInformationItems extends ClassStructure
{
    const BK = 'BK';
    ...
    /** @var OrderAckLineItemItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var OrderAckLineItemItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var OrderAckLineItemItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = OrderAckLineItemItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = OrderAckLineItemItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = OrderAckLineItemItemsCarrierInformationItemsSealNumbersItems::schema();
