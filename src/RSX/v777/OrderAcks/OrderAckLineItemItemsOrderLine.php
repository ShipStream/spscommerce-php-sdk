 ...
 */
class OrderAckLineItemItemsOrderLine extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var OrderAckLineItemItemsOrderLineProductIDItems[]|array */
    public $productID;
    ...
    /** @var OrderAckLineItemItemsOrderLineNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = OrderAckLineItemItemsOrderLineProductIDItems::schema();
        ...
        $properties->nRFStandardColorAndSize = OrderAckLineItemItemsOrderLineNRFStandardColorAndSize::schema();
