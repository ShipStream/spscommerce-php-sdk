 ...
 */
class OrderChangeAckHeaderReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var OrderChangeAckHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderChangeAckHeaderReferencesItemsReferenceIDsItems::schema();
