 ...
 */
class OrderChangeAckLineItemItemsChargesAllowancesItems extends ClassStructure
{
    const A = 'A';
    ...
    /** @var OrderChangeAckLineItemItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = OrderChangeAckLineItemItemsChargesAllowancesItemsTaxesItems::schema();
