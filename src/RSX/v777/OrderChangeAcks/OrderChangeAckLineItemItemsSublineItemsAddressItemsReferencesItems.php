 ...
 */
class OrderChangeAckLineItemItemsSublineItemsAddressItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var OrderChangeAckLineItemItemsSublineItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderChangeAckLineItemItemsSublineItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
