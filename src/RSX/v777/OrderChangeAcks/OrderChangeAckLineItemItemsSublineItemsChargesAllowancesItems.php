 ...
 */
class OrderChangeAckLineItemItemsSublineItemsChargesAllowancesItems extends ClassStructure
{
    const A = 'A';
    ...
    /** @var OrderChangeAckLineItemItemsSublineItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = OrderChangeAckLineItemItemsSublineItemsChargesAllowancesItemsTaxesItems::schema();
