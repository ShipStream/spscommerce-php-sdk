 ...
 */
class OrderChangeHeaderCarrierInformationItemsAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var OrderChangeHeaderCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = OrderChangeHeaderCarrierInformationItemsAddressItemsDatesItems::schema();
