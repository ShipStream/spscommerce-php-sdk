 ...
 */
class OrderChangeHeaderContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var OrderChangeHeaderContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = OrderChangeHeaderContactsItemsAdditionalContactDetailsItems::schema();
