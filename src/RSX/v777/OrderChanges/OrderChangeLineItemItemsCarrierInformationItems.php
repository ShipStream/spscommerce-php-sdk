 ...
 */
class OrderChangeLineItemItemsCarrierInformationItems extends ClassStructure
{
    const BK = 'BK';
    ...
    /** @var OrderChangeLineItemItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var OrderChangeLineItemItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var OrderChangeLineItemItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = OrderChangeLineItemItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = OrderChangeLineItemItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = OrderChangeLineItemItemsCarrierInformationItemsSealNumbersItems::schema();
