 ...
 */
class OrderChangeLineItemItemsMasterItemAttributeItems extends ClassStructure
{
    /** @var OrderChangeLineItemItemsMasterItemAttributeItemsItemAttributeItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->itemAttribute->items = OrderChangeLineItemItemsMasterItemAttributeItemsItemAttributeItems::schema();
