 ...
 */
class OrderChangeLineItemItemsOrderLine extends ClassStructure
{
    const AI = 'AI';
    ...
    /** @var OrderChangeLineItemItemsOrderLineProductIDItems[]|array */
    public $productID;
    ...
    /** @var OrderChangeLineItemItemsOrderLineNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = OrderChangeLineItemItemsOrderLineProductIDItems::schema();
        $ownerSchema->addPropertyMapping('ProductID', self::names()->productID);
        $properties->lineChangeCode = Schema::string();
        $properties->lineChangeCode->enum = array(
            self::AI,
            self::CA,
            self::CC,
            self::CE,
        ...
        $properties->nRFStandardColorAndSize = OrderChangeLineItemItemsOrderLineNRFStandardColorAndSize::schema();
