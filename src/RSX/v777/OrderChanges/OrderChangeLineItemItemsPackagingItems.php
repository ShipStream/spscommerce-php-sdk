 ...
 */
class OrderChangeLineItemItemsPackagingItems extends ClassStructure
{
    const CONST_10 = '10';
    ...
    /** @var OrderChangeLineItemItemsPackagingItemsMeasurementsItems[]|array */
    public $measurements;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->measurements->items = OrderChangeLineItemItemsPackagingItemsMeasurementsItems::schema();
