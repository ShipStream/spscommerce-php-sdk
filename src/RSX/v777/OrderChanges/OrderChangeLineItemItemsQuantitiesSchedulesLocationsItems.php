 ...
 */
class OrderChangeLineItemItemsQuantitiesSchedulesLocationsItems extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var OrderChangeLineItemItemsQuantitiesSchedulesLocationsItemsLocationQuantityItems[]|array */
    public $locationQuantity;

    /** @var OrderChangeLineItemItemsQuantitiesSchedulesLocationsItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->locationQuantity->items = OrderChangeLineItemItemsQuantitiesSchedulesLocationsItemsLocationQuantityItems::schema();
        $ownerSchema->addPropertyMapping('LocationQuantity', self::names()->locationQuantity);
        $properties->dates = Schema::arr();
        $properties->dates->items = OrderChangeLineItemItemsQuantitiesSchedulesLocationsItemsDatesItems::schema();
