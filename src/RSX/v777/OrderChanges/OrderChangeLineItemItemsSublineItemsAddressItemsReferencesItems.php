 ...
 */
class OrderChangeLineItemItemsSublineItemsAddressItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var OrderChangeLineItemItemsSublineItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderChangeLineItemItemsSublineItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
