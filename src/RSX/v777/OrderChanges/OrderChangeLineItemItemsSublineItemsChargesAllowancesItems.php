 ...
 */
class OrderChangeLineItemItemsSublineItemsChargesAllowancesItems extends ClassStructure
{
    const A = 'A';
    ...
    /** @var OrderChangeLineItemItemsSublineItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = OrderChangeLineItemItemsSublineItemsChargesAllowancesItemsTaxesItems::schema();
