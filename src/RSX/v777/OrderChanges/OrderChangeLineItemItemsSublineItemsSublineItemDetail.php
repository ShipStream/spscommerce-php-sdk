 ...
 */
class OrderChangeLineItemItemsSublineItemsSublineItemDetail extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var OrderChangeLineItemItemsSublineItemsSublineItemDetailProductIDItems[]|array */
    public $productID;
    ...
    /** @var OrderChangeLineItemItemsSublineItemsSublineItemDetailNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = OrderChangeLineItemItemsSublineItemsSublineItemDetailProductIDItems::schema();
        ...
        $properties->nRFStandardColorAndSize = OrderChangeLineItemItemsSublineItemsSublineItemDetailNRFStandardColorAndSize::schema();
