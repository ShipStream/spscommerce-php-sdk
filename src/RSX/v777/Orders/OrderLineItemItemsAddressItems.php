 ...
 */
class OrderLineItemItemsAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var OrderLineItemItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var OrderLineItemItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var OrderLineItemItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = OrderLineItemItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = OrderLineItemItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = OrderLineItemItemsAddressItemsDatesItems::schema();
