 ...
 */
class OrderLineItemItemsOrderLine extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var OrderLineItemItemsOrderLineProductIDItems[]|array */
    public $productID;
    ...
    /** @var OrderLineItemItemsOrderLineNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = OrderLineItemItemsOrderLineProductIDItems::schema();
        ...
        $properties->nRFStandardColorAndSize = OrderLineItemItemsOrderLineNRFStandardColorAndSize::schema();
