 ...
 */
class OrderLineItemItemsQuantitiesSchedulesLocationsItems extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var OrderLineItemItemsQuantitiesSchedulesLocationsItemsLocationQuantityItems[]|array */
    public $locationQuantity;

    /** @var OrderLineItemItemsQuantitiesSchedulesLocationsItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->locationQuantity->items = OrderLineItemItemsQuantitiesSchedulesLocationsItemsLocationQuantityItems::schema();
        $ownerSchema->addPropertyMapping('LocationQuantity', self::names()->locationQuantity);
        $properties->dates = Schema::arr();
        $properties->dates->items = OrderLineItemItemsQuantitiesSchedulesLocationsItemsDatesItems::schema();
