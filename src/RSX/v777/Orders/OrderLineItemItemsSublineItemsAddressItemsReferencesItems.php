 ...
 */
class OrderLineItemItemsSublineItemsAddressItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var OrderLineItemItemsSublineItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrderLineItemItemsSublineItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
