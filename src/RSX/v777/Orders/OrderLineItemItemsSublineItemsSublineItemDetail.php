 ...
 */
class OrderLineItemItemsSublineItemsSublineItemDetail extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var OrderLineItemItemsSublineItemsSublineItemDetailProductIDItems[]|array */
    public $productID;
    ...
    /** @var OrderLineItemItemsSublineItemsSublineItemDetailNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = OrderLineItemItemsSublineItemsSublineItemDetailProductIDItems::schema();
        ...
        $properties->nRFStandardColorAndSize = OrderLineItemItemsSublineItemsSublineItemDetailNRFStandardColorAndSize::schema();
