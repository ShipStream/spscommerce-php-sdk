 ...
 */
class OrganizationalRelationshipHeaderAddressItemsContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var OrganizationalRelationshipHeaderAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = OrganizationalRelationshipHeaderAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
