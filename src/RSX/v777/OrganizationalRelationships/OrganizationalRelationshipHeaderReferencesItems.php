 ...
 */
class OrganizationalRelationshipHeaderReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var OrganizationalRelationshipHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrganizationalRelationshipHeaderReferencesItemsReferenceIDsItems::schema();
