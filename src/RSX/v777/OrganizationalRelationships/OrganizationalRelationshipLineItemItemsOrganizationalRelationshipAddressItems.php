...
/**
 * Encloses transaction detail information
 */
class OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItems extends ClassStructure
{
    /** @var OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItemsAddress Represent an entity such as an organizational, physical location, property, or individual */
    public $address;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $ownerSchema->description = "Encloses transaction detail information";
