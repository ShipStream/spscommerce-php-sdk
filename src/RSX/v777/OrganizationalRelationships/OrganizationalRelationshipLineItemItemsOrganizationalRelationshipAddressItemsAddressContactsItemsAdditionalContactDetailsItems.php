 ...
 */
class OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItemsAddressContactsItemsAdditionalContactDetailsItems extends ClassStructure
{
    const AU = 'AU';
