 ...
 */
class OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItemsAddressReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItemsAddressReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = OrganizationalRelationshipLineItemItemsOrganizationalRelationshipAddressItemsAddressReferencesItemsReferenceIDsItems::schema();
