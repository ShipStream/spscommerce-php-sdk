 ...
 */
class PlanningScheduleHeaderAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var PlanningScheduleHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var PlanningScheduleHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var PlanningScheduleHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = PlanningScheduleHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = PlanningScheduleHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = PlanningScheduleHeaderAddressItemsDatesItems::schema();
