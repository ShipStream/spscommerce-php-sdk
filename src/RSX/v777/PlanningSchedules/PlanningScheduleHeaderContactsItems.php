 ...
 */
class PlanningScheduleHeaderContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var PlanningScheduleHeaderContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = PlanningScheduleHeaderContactsItemsAdditionalContactDetailsItems::schema();
