 ...
 */
class PlanningScheduleLineItemItemsForecastDeliveryItemsForecastScheduleItemsQuantitiesSchedulesLocationsItems extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var PlanningScheduleLineItemItemsForecastDeliveryItemsForecastScheduleItemsQuantitiesSchedulesLocationsItemsLocationQuantityItems[]|array */
    public $locationQuantity;

    /** @var PlanningScheduleLineItemItemsForecastDeliveryItemsForecastScheduleItemsQuantitiesSchedulesLocationsItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->locationQuantity->items = PlanningScheduleLineItemItemsForecastDeliveryItemsForecastScheduleItemsQuantitiesSchedulesLocationsItemsLocationQuantityItems::schema();
        $ownerSchema->addPropertyMapping('LocationQuantity', self::names()->locationQuantity);
        $properties->dates = Schema::arr();
        $properties->dates->items = PlanningScheduleLineItemItemsForecastDeliveryItemsForecastScheduleItemsQuantitiesSchedulesLocationsItemsDatesItems::schema();
