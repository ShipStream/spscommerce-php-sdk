...
class PlanningScheduleLineItemItemsPlanningLine extends ClassStructure
{
    ...
    /** @var string Identifies the status of a forecasted product */
    public $partReleaseCode;

    /** @var string Further describes the status of a forecasted product */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->partReleaseCode->description = "Identifies the status of a forecasted product";
        $ownerSchema->addPropertyMapping('PartReleaseCode', self::names()->partReleaseCode);
        $properties->partReleaseDescription = Schema::string();
        $properties->partReleaseDescription->description = "Further describes the status of a forecasted product";
