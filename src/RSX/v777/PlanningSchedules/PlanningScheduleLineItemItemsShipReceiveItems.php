...
/**
 * Details of delivered shipments
 */
class PlanningScheduleLineItemItemsShipReceiveItems extends ClassStructure
{
    ...
    /** @var float Amount as defined by the QuantityQualifier */
    public $shipReceiveQty;

    /** @var string Code specifying the type of date */
    public $shipReceiveDateQualifier;

    /** @var string First shipment date, as defined by the ShipReceiveDateQualifier */
    public $shipReceiveDate;

    /** @var string First shipment time, as defined by the ShipReceiveDateQualifier */
    public $shipReceiveTime;

    /** @var string Final date */
    public $endDate;

    /** @var string Final time */
    public $endTime;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->shipReceiveQty->description = "Amount as defined by the QuantityQualifier";
        $ownerSchema->addPropertyMapping('ShipReceiveQty', self::names()->shipReceiveQty);
        $properties->shipReceiveDateQualifier = Schema::string();
        $properties->shipReceiveDateQualifier->enum = array(
            self::CONST_001,
            self::CONST_002,
            self::CONST_006,
            self::CONST_007,
        ...
        $properties->shipReceiveDateQualifier->description = "Code specifying the type of date";
        ...
        $properties->shipReceiveDate->description = "First shipment date, as defined by the ShipReceiveDateQualifier";
        ...
        $properties->shipReceiveTime->description = "First shipment time, as defined by the ShipReceiveDateQualifier";
        ...
        $ownerSchema->description = "Details of delivered shipments";
