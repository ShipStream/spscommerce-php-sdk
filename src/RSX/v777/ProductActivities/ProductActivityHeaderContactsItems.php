 ...
 */
class ProductActivityHeaderContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var ProductActivityHeaderContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = ProductActivityHeaderContactsItemsAdditionalContactDetailsItems::schema();
