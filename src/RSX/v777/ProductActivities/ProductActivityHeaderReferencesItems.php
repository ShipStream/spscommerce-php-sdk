 ...
 */
class ProductActivityHeaderReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var ProductActivityHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ProductActivityHeaderReferencesItemsReferenceIDsItems::schema();
