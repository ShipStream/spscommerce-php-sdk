 ...
 */
class ProductActivityLineItemItemsAddressItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var ProductActivityLineItemItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ProductActivityLineItemItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
