...
class ProductActivityLineItemItemsProductActivityReportingItems extends ClassStructure
{
    ...
    /** @var ProductActivityLineItemItemsProductActivityReportingItemsDates Provides date and time information */
    public $dates;

    /** @var ProductActivityLineItemItemsProductActivityReportingItemsReferences Supplemental information supporting the transaction */
    public $references;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->activityCode->enum = array(
            self::DG,
            self::HL,
            self::OP,
            self::OQ,
