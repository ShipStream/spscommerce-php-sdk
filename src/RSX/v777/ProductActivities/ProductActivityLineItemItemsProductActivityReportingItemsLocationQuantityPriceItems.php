...
/**
 * Provides quantity and price information as it relates to a particular location
 */
class ProductActivityLineItemItemsProductActivityReportingItemsLocationQuantityPriceItems extends ClassStructure
{
    ...
    /** @var float Relates an amount to a location */
    public $locationQty;

    /** @var string The unit of measure used in relation to a location quantity */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->locationQtyUOM->description = "The unit of measure used in relation to a location quantity";
        ...
        $ownerSchema->description = "Provides quantity and price information as it relates to a particular location";
