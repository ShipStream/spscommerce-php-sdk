 ...
 */
class ProductActivityLineItemItemsProductActivityReportingItemsReferences extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var ProductActivityLineItemItemsProductActivityReportingItemsReferencesReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ProductActivityLineItemItemsProductActivityReportingItemsReferencesReferenceIDsItems::schema();
