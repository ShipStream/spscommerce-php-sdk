 ...
 */
class ProductActivityLineItemItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var ProductActivityLineItemItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ProductActivityLineItemItemsReferencesItemsReferenceIDsItems::schema();
