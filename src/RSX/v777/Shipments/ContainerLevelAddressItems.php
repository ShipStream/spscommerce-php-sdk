 ...
 */
class ContainerLevelAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var ContainerLevelAddressItemsReferencesItems[]|array */
    public $references;

    /** @var ContainerLevelAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var ContainerLevelAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = ContainerLevelAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = ContainerLevelAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = ContainerLevelAddressItemsDatesItems::schema();
