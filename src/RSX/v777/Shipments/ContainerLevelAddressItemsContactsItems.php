 ...
 */
class ContainerLevelAddressItemsContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var ContainerLevelAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = ContainerLevelAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
