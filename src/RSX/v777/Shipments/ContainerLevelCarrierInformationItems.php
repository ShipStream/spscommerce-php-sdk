 ...
 */
class ContainerLevelCarrierInformationItems extends ClassStructure
{
    const BK = 'BK';
    ...
    /** @var ContainerLevelCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var ContainerLevelCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var ContainerLevelCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = ContainerLevelCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = ContainerLevelCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = ContainerLevelCarrierInformationItemsSealNumbersItems::schema();
