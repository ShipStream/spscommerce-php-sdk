...
/**
 * Contains the commonly used fields in the container level of the transaction
 */
class ContainerLevelContainer extends ClassStructure
{
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $ownerSchema->description = "Contains the commonly used fields in the container level of the transaction";
