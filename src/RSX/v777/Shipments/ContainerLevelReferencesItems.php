 ...
 */
class ContainerLevelReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var ContainerLevelReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ContainerLevelReferencesItemsReferenceIDsItems::schema();
