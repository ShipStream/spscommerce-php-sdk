 ...
 */
class ItemLevelChargesAllowancesItems extends ClassStructure
{
    const A = 'A';
    ...
    /** @var ItemLevelChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = ItemLevelChargesAllowancesItemsTaxesItems::schema();
