 ...
 */
class ItemLevelMasterItemAttributeItems extends ClassStructure
{
    /** @var ItemLevelMasterItemAttributeItemsItemAttributeItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->itemAttribute->items = ItemLevelMasterItemAttributeItemsItemAttributeItems::schema();
