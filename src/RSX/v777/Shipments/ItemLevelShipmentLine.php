 ...
 */
class ItemLevelShipmentLine extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var ItemLevelShipmentLineProductIDItems[]|array */
    public $productID;
    ...
    /** @var ItemLevelShipmentLineNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = ItemLevelShipmentLineProductIDItems::schema();
        ...
        $properties->nRFStandardColorAndSize = ItemLevelShipmentLineNRFStandardColorAndSize::schema();
