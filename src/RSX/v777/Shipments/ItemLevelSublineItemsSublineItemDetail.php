 ...
 */
class ItemLevelSublineItemsSublineItemDetail extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var ItemLevelSublineItemsSublineItemDetailProductIDItems[]|array */
    public $productID;
    ...
    /** @var ItemLevelSublineItemsSublineItemDetailNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = ItemLevelSublineItemsSublineItemDetailProductIDItems::schema();
        ...
        $properties->nRFStandardColorAndSize = ItemLevelSublineItemsSublineItemDetailNRFStandardColorAndSize::schema();
