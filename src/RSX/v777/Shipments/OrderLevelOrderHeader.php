 ...
 */
class OrderLevelOrderHeader extends ClassStructure
{
    ...
    /** @var string Date the shipment was requested to be delivered */
    public $deliveryDate;

    /** @var string Time the shipment was requested to be delivered */
    public $deliveryTime;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->deliveryDate->description = "Date the shipment was requested to be delivered";
        ...
        $properties->deliveryTime->description = "Time the shipment was requested to be delivered";
