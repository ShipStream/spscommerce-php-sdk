 ...
 */
class PackLevelAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var PackLevelAddressItemsReferencesItems[]|array */
    public $references;

    /** @var PackLevelAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var PackLevelAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = PackLevelAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = PackLevelAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = PackLevelAddressItemsDatesItems::schema();
