 ...
 */
class PackLevelReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var PackLevelReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = PackLevelReferencesItemsReferenceIDsItems::schema();
