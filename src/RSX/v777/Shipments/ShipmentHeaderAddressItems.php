 ...
 */
class ShipmentHeaderAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var ShipmentHeaderAddressItemsReferencesItems[]|array */
    public $references;

    /** @var ShipmentHeaderAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var ShipmentHeaderAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = ShipmentHeaderAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = ShipmentHeaderAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = ShipmentHeaderAddressItemsDatesItems::schema();
