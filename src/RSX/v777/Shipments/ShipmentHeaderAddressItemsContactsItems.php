 ...
 */
class ShipmentHeaderAddressItemsContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var ShipmentHeaderAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = ShipmentHeaderAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
