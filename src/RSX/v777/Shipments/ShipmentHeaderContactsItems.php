 ...
 */
class ShipmentHeaderContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var ShipmentHeaderContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = ShipmentHeaderContactsItemsAdditionalContactDetailsItems::schema();
