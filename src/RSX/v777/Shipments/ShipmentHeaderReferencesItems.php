 ...
 */
class ShipmentHeaderReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var ShipmentHeaderReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ShipmentHeaderReferencesItemsReferenceIDsItems::schema();
