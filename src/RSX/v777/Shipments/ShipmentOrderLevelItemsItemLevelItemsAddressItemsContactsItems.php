 ...
 */
class ShipmentOrderLevelItemsItemLevelItemsAddressItemsContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var ShipmentOrderLevelItemsItemLevelItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = ShipmentOrderLevelItemsItemLevelItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
