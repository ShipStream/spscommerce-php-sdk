 ...
 */
class ShipmentOrderLevelItemsItemLevelItemsCarrierInformationItems extends ClassStructure
{
    const BK = 'BK';
    ...
    /** @var ShipmentOrderLevelItemsItemLevelItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var ShipmentOrderLevelItemsItemLevelItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var ShipmentOrderLevelItemsItemLevelItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = ShipmentOrderLevelItemsItemLevelItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = ShipmentOrderLevelItemsItemLevelItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = ShipmentOrderLevelItemsItemLevelItemsCarrierInformationItemsSealNumbersItems::schema();
