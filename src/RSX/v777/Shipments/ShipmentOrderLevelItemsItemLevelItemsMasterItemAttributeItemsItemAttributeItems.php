 ...
 */
class ShipmentOrderLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItems extends ClassStructure
{
    ...
    /** @var ShipmentOrderLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItemsMeasurementsItems[]|array */
    public $measurements;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->measurements->items = ShipmentOrderLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItemsMeasurementsItems::schema();
