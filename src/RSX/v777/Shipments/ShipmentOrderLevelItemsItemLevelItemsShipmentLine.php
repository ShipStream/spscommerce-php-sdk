 ...
 */
class ShipmentOrderLevelItemsItemLevelItemsShipmentLine extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var ShipmentOrderLevelItemsItemLevelItemsShipmentLineProductIDItems[]|array */
    public $productID;
    ...
    /** @var ShipmentOrderLevelItemsItemLevelItemsShipmentLineNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = ShipmentOrderLevelItemsItemLevelItemsShipmentLineProductIDItems::schema();
        ...
        $properties->nRFStandardColorAndSize = ShipmentOrderLevelItemsItemLevelItemsShipmentLineNRFStandardColorAndSize::schema();
