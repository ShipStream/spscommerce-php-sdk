 ...
 */
class ShipmentOrderLevelItemsItemLevelItemsSublineItemsSublineItemDetail extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var ShipmentOrderLevelItemsItemLevelItemsSublineItemsSublineItemDetailProductIDItems[]|array */
    public $productID;
    ...
    /** @var ShipmentOrderLevelItemsItemLevelItemsSublineItemsSublineItemDetailNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = ShipmentOrderLevelItemsItemLevelItemsSublineItemsSublineItemDetailProductIDItems::schema();
        ...
        $properties->nRFStandardColorAndSize = ShipmentOrderLevelItemsItemLevelItemsSublineItemsSublineItemDetailNRFStandardColorAndSize::schema();
