 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsAddressItemsDatesItems::schema();
