 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItems extends ClassStructure
{
    const BK = 'BK';
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsServiceLevelCodesItems[]|array */
    public $serviceLevelCodes;

    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsAddressItems[]|array */
    public $address;

    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsSealNumbersItems[]|array */
    public $sealNumbers;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->serviceLevelCodes->items = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsServiceLevelCodesItems::schema();
        $ownerSchema->addPropertyMapping('ServiceLevelCodes', self::names()->serviceLevelCodes);
        $properties->address = Schema::arr();
        $properties->address->items = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsAddressItems::schema();
        $ownerSchema->addPropertyMapping('Address', self::names()->address);
        $properties->sealNumbers = Schema::arr();
        $properties->sealNumbers->items = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsSealNumbersItems::schema();
