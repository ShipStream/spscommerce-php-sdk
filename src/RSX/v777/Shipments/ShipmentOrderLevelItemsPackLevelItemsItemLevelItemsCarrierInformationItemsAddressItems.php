 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->dates->items = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsCarrierInformationItemsAddressItemsDatesItems::schema();
