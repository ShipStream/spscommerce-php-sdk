 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsChargesAllowancesItems extends ClassStructure
{
    const A = 'A';
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsChargesAllowancesItemsTaxesItems[]|array */
    public $taxes;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->taxes->items = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsChargesAllowancesItemsTaxesItems::schema();
