 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsMasterItemAttributeItems extends ClassStructure
{
    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->itemAttribute->items = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItems::schema();
