 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsShipmentLine extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsShipmentLineProductIDItems[]|array */
    public $productID;
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsShipmentLineNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsShipmentLineProductIDItems::schema();
        ...
        $properties->nRFStandardColorAndSize = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsShipmentLineNRFStandardColorAndSize::schema();
