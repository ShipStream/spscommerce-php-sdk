 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsSublineItemsSublineItemDetail extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsSublineItemsSublineItemDetailProductIDItems[]|array */
    public $productID;
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsSublineItemsSublineItemDetailNRFStandardColorAndSize Color and size information conforming to standards set forth by the National Retail Federation */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsSublineItemsSublineItemDetailProductIDItems::schema();
        ...
        $properties->nRFStandardColorAndSize = ShipmentOrderLevelItemsPackLevelItemsItemLevelItemsSublineItemsSublineItemDetailNRFStandardColorAndSize::schema();
