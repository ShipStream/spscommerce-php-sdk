 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsAddressItems extends ClassStructure
{
    const CONST_88 = '88';
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsAddressItemsReferencesItems[]|array */
    public $references;

    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsAddressItemsContactsItems[]|array */
    public $contacts;

    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsAddressItemsDatesItems[]|array */
    public $dates;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->references->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsAddressItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $properties->contacts = Schema::arr();
        $properties->contacts->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsAddressItemsContactsItems::schema();
        $ownerSchema->addPropertyMapping('Contacts', self::names()->contacts);
        $properties->dates = Schema::arr();
        $properties->dates->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsAddressItemsDatesItems::schema();
