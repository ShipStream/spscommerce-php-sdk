 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsAddressItemsContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsAddressItemsContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsAddressItemsContactsItemsAdditionalContactDetailsItems::schema();
