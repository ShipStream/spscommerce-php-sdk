...
/**
 * Encloses all document item elements
 */
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItems extends ClassStructure
{
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsShipmentLine Contains the commonly used fields in the item level of the transaction */
    public $shipmentLine;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $ownerSchema->description = "Encloses all document item elements";
