 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsAddressItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsAddressItemsReferencesItemsReferenceIDsItems::schema();
