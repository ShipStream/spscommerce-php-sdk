 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsItemLoadInfoItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsItemLoadInfoItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsItemLoadInfoItemsReferencesItemsReferenceIDsItems::schema();
