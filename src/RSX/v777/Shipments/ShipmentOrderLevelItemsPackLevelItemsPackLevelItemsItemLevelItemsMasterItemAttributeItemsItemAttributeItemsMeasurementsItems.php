 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsMasterItemAttributeItemsItemAttributeItemsMeasurementsItems extends ClassStructure
{
    const CNSM = 'CNSM';
