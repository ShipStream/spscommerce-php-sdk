...
{
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsItemLevelItemsSublineItemsSublineItemDetail Contains the commonly used fields in the subline level of the transaction */
