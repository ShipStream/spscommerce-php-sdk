...
/**
 * Provides pack identifier and type
 */
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsPack extends ClassStructure
{
    const P = 'P';
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->packLevelType->enum = array(
            self::P,
            self::T,
        );
        ...
        $ownerSchema->description = "Provides pack identifier and type";
