 ...
 */
class ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ShipmentOrderLevelItemsPackLevelItemsPackLevelItemsReferencesItemsReferenceIDsItems::schema();
