 ...
 */
class ShipmentOrderLevelItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var ShipmentOrderLevelItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = ShipmentOrderLevelItemsReferencesItemsReferenceIDsItems::schema();
