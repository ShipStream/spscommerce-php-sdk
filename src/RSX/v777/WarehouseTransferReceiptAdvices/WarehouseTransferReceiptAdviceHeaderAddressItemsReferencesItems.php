 ...
 */
class WarehouseTransferReceiptAdviceHeaderAddressItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var WarehouseTransferReceiptAdviceHeaderAddressItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = WarehouseTransferReceiptAdviceHeaderAddressItemsReferencesItemsReferenceIDsItems::schema();
