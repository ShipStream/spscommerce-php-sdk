 ...
 */
class WarehouseTransferReceiptAdviceHeaderContactsItems extends ClassStructure
{
    const AL = 'AL';
    ...
    /** @var WarehouseTransferReceiptAdviceHeaderContactsItemsAdditionalContactDetailsItems[]|array */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->additionalContactDetails->items = WarehouseTransferReceiptAdviceHeaderContactsItemsAdditionalContactDetailsItems::schema();
