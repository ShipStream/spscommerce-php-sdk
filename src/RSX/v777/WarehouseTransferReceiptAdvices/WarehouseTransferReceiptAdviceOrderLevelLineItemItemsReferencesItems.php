 ...
 */
class WarehouseTransferReceiptAdviceOrderLevelLineItemItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var WarehouseTransferReceiptAdviceOrderLevelLineItemItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = WarehouseTransferReceiptAdviceOrderLevelLineItemItemsReferencesItemsReferenceIDsItems::schema();
