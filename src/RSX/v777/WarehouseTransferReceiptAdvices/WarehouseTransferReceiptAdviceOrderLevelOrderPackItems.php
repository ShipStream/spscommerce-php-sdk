...
/**
 * Details product packing information
 */
class WarehouseTransferReceiptAdviceOrderLevelOrderPackItems extends ClassStructure
{
    /** @var WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsWarehousePack Details pack identifications */
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $ownerSchema->description = "Details product packing information";
