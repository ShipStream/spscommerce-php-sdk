...
/**
 * Amounts and conditions of received products
 */
class WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsLineItemItemsDetailResponseItems extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var string Unique value assigned to a grouping of products by the warehouse for tracking purposes */
    public $warehouseLotID;

    /** @var string Code specifying the type of damage */
    public $damageReasonCode;

    /** @var WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsLineItemItemsDetailResponseItemsReferencesItems[]|array */
    public $references;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->warehouseLotID->description = "Unique value assigned to a grouping of products by the warehouse for tracking purposes";
        $ownerSchema->addPropertyMapping('WarehouseLotID', self::names()->warehouseLotID);
        $properties->damageReasonCode = Schema::string();
        $properties->damageReasonCode->enum = array(
            self::CC,
            self::DL,
            self::DP,
            self::HD,
        ...
        $properties->references->items = WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsLineItemItemsDetailResponseItemsReferencesItems::schema();
        $ownerSchema->addPropertyMapping('References', self::names()->references);
        $ownerSchema->type = Schema::OBJECT;
        $ownerSchema->additionalProperties = false;
        $ownerSchema->description = "Amounts and conditions of received products";
