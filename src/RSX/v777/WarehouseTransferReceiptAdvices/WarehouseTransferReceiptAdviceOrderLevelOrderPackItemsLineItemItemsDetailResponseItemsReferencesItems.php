 ...
 */
class WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsLineItemItemsDetailResponseItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsLineItemItemsDetailResponseItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsLineItemItemsDetailResponseItemsReferencesItemsReferenceIDsItems::schema();
