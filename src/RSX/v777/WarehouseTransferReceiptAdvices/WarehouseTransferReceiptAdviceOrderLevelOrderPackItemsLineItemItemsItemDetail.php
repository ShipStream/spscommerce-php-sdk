 ...
 */
class WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsLineItemItemsItemDetail extends ClassStructure
{
    const CONST_01 = '01';
    ...
    /** @var WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsLineItemItemsItemDetailProductIDItems[]|array */
    public $productID;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->productID->items = WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsLineItemItemsItemDetailProductIDItems::schema();
        ...
        $properties->warehouseDetailAdjID->description = "This field is deprecated";
        ...
        $properties->color->description = "Name of a color";
