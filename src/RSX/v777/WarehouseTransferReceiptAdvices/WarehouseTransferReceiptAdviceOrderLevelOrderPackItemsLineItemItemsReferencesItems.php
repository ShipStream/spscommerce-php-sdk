 ...
 */
class WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsLineItemItemsReferencesItems extends ClassStructure
{
    const CONST_02 = '02';
    ...
    /** @var WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsLineItemItemsReferencesItemsReferenceIDsItems[]|array */
    public $referenceIDs;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->referenceIDs->items = WarehouseTransferReceiptAdviceOrderLevelOrderPackItemsLineItemItemsReferencesItemsReferenceIDsItems::schema();
